...
export const rentalsUpdateOneSchema: z.ZodType<Prisma.rentalsUpdateArgs> = z
  .object({
    select: rentalsSelectObjectSchema.optional(),
    include: rentalsIncludeObjectSchema.optional(),
    data: z.union([
      rentalsUpdateInputObjectSchema,
      rentalsUncheckedUpdateInputObjectSchema,
    ]),
    where: rentalsWhereUniqueInputObjectSchema,
  })
  .strict() as unknown as z.ZodType<Prisma.rentalsUpdateArgs>

export const rentalsUpdateOneZodSchema = z
  .object({
    select: rentalsSelectObjectSchema.optional(),
    include: rentalsIncludeObjectSchema.optional(),
    data: z.union([
