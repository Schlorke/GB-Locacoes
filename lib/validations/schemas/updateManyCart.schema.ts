...
export const CartUpdateManySchema: z.ZodType<Prisma.CartUpdateManyArgs> = z
  .object({
    data: CartUpdateManyMutationInputObjectSchema,
    where: CartWhereInputObjectSchema.optional(),
  })
  .strict() as unknown as z.ZodType<Prisma.CartUpdateManyArgs>

export const CartUpdateManyZodSchema = z
  .object({
    data: CartUpdateManyMutationInputObjectSchema,
    where: CartWhereInputObjectSchema.optional(),
  })
