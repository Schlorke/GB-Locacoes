...
export const CartFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CartSelect> = z
  .object({
...
export const CartFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const CartFindFirstOrThrowSchema: z.ZodType<Prisma.CartFindFirstOrThrowArgs> =
  z
    .object({
      select: CartFindFirstOrThrowSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.CartFindFirstOrThrowArgs>

export const CartFindFirstOrThrowZodSchema = z
  .object({
    select: CartFindFirstOrThrowSelectSchema.optional(),
    include: CartIncludeObjectSchema.optional(),
    orderBy: z
