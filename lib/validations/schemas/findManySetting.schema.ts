...
export const SettingFindManySelectSchema: z.ZodType<Prisma.SettingSelect> = z
  .object({
...
export const SettingFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    companyPhone: z.boolean().optional(),
    companyIconUrl: z.boolean().optional(),
...
export const SettingFindManySchema: z.ZodType<Prisma.SettingFindManyArgs> = z
  .object({
    select: SettingFindManySelectSchema.optional(),
    orderBy: z
      .union([
  ...
  .strict() as unknown as z.ZodType<Prisma.SettingFindManyArgs>

export const SettingFindManyZodSchema = z
  .object({
    select: SettingFindManySelectSchema.optional(),
    orderBy: z
      .union([
