...
export const QuoteDeleteOneSchema: z.ZodType<Prisma.QuoteDeleteArgs> = z
  .object({
    select: QuoteSelectObjectSchema.optional(),
    include: QuoteIncludeObjectSchema.optional(),
    where: QuoteWhereUniqueInputObjectSchema,
  })
  .strict() as unknown as z.ZodType<Prisma.QuoteDeleteArgs>

export const QuoteDeleteOneZodSchema = z
  .object({
    select: QuoteSelectObjectSchema.optional(),
    include: QuoteIncludeObjectSchema.optional(),
    where: QuoteWhereUniqueInputObjectSchema,
