...
export const rental_itemsGroupBySchema: z.ZodType<Prisma.rental_itemsGroupByArgs> = z.object({ where: rental_itemsWhereInputObjectSchema.optional(), orderBy: z.union([rental_itemsOrderByWithAggregationInputObjectSchema, rental_itemsOrderByWithAggregationInputObjectSchema.array()]).optional(), having: rental_itemsScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(RentalItemsScalarFieldEnumSchema), _count: z.union([ z.literal(true), Rental_itemsCountAggregateInputObjectSchema ]).optional(), _min: Rental_itemsMinAggregateInputObjectSchema.optional(), _max: Rental_itemsMaxAggregateInputObjectSchema.optional(), _avg: Rental_itemsAvgAggregateInputObjectSchema.optional(), _sum: Rental_itemsSumAggregateInputObjectSchema.optional() }).strict() as unknown as z.ZodType<Prisma.rental_itemsGroupByArgs>;

export const rental_itemsGroupByZodSchema = z.object({ where: rental_itemsWhereInputObjectSchema.optional(), orderBy: z.union([rental_itemsOrderByWithAggregationInputObjectSchema, rental_itemsOrderByWithAggregationInputObjectSchema.array()]).optional(), having: rental_itemsScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(RentalItemsScalarFieldEnumSchema), _count: z.union([ z.literal(true), Rental_itemsCountAggregateInputObjectSchema ]).optional(), _min: Rental_itemsMinAggregateInputObjectSchema.optional(), _max: Rental_itemsMaxAggregateInputObjectSchema.optional(), _avg: Rental_itemsAvgAggregateInputObjectSchema.optional(), _sum: Rental_itemsSumAggregateInputObjectSchema.optional() }).strict();