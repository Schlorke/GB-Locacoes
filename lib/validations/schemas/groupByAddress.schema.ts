...
export const AddressGroupBySchema: z.ZodType<Prisma.AddressGroupByArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.AddressGroupByArgs>

export const AddressGroupByZodSchema = z
  .object({
    where: AddressWhereInputObjectSchema.optional(),
    orderBy: z
      .union([
