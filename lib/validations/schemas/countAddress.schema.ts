...
export const AddressCountSchema: z.ZodType<Prisma.AddressCountArgs> = z
  .object({
    orderBy: z
      .union([
  ...
  .strict() as unknown as z.ZodType<Prisma.AddressCountArgs>

export const AddressCountZodSchema = z
  .object({
    orderBy: z
      .union([
        AddressOrderByWithRelationInputObjectSchema,
