...
export const SettingUpdateManyAndReturnSchema = z.object({ select: SettingSelectObjectSchema.optional(), data: SettingUpdateManyMutationInputObjectSchema, where: SettingWhereInputObjectSchema.optional()  }).strict()