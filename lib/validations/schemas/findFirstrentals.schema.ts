...
export const rentalsFindFirstSchema: z.ZodType<Prisma.rentalsFindFirstArgs> = z.object({ select: rentalsFindFirstSelectSchema.optional(), include: rentalsIncludeObjectSchema.optional(), orderBy: z.union([rentalsOrderByWithRelationInputObjectSchema, rentalsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rentalsWhereInputObjectSchema.optional(), cursor: rentalsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RentalsScalarFieldEnumSchema, RentalsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.rentalsFindFirstArgs>;

export const rentalsFindFirstZodSchema = z.object({ select: rentalsFindFirstSelectSchema.optional(), include: rentalsIncludeObjectSchema.optional(), orderBy: z.union([rentalsOrderByWithRelationInputObjectSchema, rentalsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rentalsWhereInputObjectSchema.optional(), cursor: rentalsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RentalsScalarFieldEnumSchema, RentalsScalarFieldEnumSchema.array()]).optional() }).strict();