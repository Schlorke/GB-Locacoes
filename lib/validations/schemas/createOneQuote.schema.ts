...
export const QuoteCreateOneSchema: z.ZodType<Prisma.QuoteCreateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.QuoteCreateArgs>

export const QuoteCreateOneZodSchema = z
  .object({
    select: QuoteSelectObjectSchema.optional(),
    include: QuoteIncludeObjectSchema.optional(),
    data: z.union([
