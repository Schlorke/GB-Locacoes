...
export const CartItemFindUniqueOrThrowSchema: z.ZodType<Prisma.CartItemFindUniqueOrThrowArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CartItemFindUniqueOrThrowArgs>

export const CartItemFindUniqueOrThrowZodSchema = z
  .object({
    select: CartItemSelectObjectSchema.optional(),
    include: CartItemIncludeObjectSchema.optional(),
    where: CartItemWhereUniqueInputObjectSchema,
