...
export const SettingDeleteOneSchema: z.ZodType<Prisma.SettingDeleteArgs> = z
  .object({
    select: SettingSelectObjectSchema.optional(),
    where: SettingWhereUniqueInputObjectSchema,
  })
  .strict() as unknown as z.ZodType<Prisma.SettingDeleteArgs>

export const SettingDeleteOneZodSchema = z
  .object({
    select: SettingSelectObjectSchema.optional(),
    where: SettingWhereUniqueInputObjectSchema,
  })
