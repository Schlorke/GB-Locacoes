...
export const QuoteUpdateManyAndReturnSchema: z.ZodType<Prisma.QuoteUpdateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.QuoteUpdateManyAndReturnArgs>

export const QuoteUpdateManyAndReturnZodSchema = z
  .object({
    select: QuoteSelectObjectSchema.optional(),
    data: QuoteUpdateManyMutationInputObjectSchema,
    where: QuoteWhereInputObjectSchema.optional(),
