...
export const QuoteUpdateManyAndReturnSchema = z.object({ select: QuoteSelectObjectSchema.optional(), data: QuoteUpdateManyMutationInputObjectSchema, where: QuoteWhereInputObjectSchema.optional()  }).strict()