...
export const DeliveryFindManySelectSchema: z.ZodType<Prisma.DeliverySelect> = z.object({
...
export const DeliveryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    rentalId: z.boolean().optional(),
    type: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const DeliveryFindManySchema: z.ZodType<Prisma.DeliveryFindManyArgs> = z.object({ select: DeliveryFindManySelectSchema.optional(), include: z.lazy(() => DeliveryIncludeObjectSchema.optional()), orderBy: z.union([DeliveryOrderByWithRelationInputObjectSchema, DeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeliveryWhereInputObjectSchema.optional(), cursor: DeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeliveryScalarFieldEnumSchema, DeliveryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DeliveryFindManyArgs>;

export const DeliveryFindManyZodSchema = z.object({ select: DeliveryFindManySelectSchema.optional(), include: z.lazy(() => DeliveryIncludeObjectSchema.optional()), orderBy: z.union([DeliveryOrderByWithRelationInputObjectSchema, DeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeliveryWhereInputObjectSchema.optional(), cursor: DeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeliveryScalarFieldEnumSchema, DeliveryScalarFieldEnumSchema.array()]).optional() }).strict();