...
export const CartUpsertOneSchema: z.ZodType<Prisma.CartUpsertArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CartUpsertArgs>

export const CartUpsertOneZodSchema = z
  .object({
    select: CartSelectObjectSchema.optional(),
    include: CartIncludeObjectSchema.optional(),
    where: CartWhereUniqueInputObjectSchema,
