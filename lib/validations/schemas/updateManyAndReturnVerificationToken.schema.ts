...
export const VerificationTokenUpdateManyAndReturnSchema = z.object({ select: VerificationTokenSelectObjectSchema.optional(),  data: VerificationTokenUpdateManyMutationInputObjectSchema, where: VerificationTokenWhereInputObjectSchema.optional()  })