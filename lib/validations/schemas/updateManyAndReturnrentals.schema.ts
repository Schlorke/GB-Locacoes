...
export const rentalsUpdateManyAndReturnSchema = z.object({ select: rentalsSelectObjectSchema.optional(), data: rentalsUpdateManyMutationInputObjectSchema, where: rentalsWhereInputObjectSchema.optional()  }).strict()