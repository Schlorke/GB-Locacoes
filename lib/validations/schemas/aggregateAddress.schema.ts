...
export const AddressAggregateSchema: z.ZodType<Prisma.AddressAggregateArgs> = z
  .object({
    orderBy: z
      .union([
  ...
  .strict() as unknown as z.ZodType<Prisma.AddressAggregateArgs>

export const AddressAggregateZodSchema = z
  .object({
    orderBy: z
      .union([
        AddressOrderByWithRelationInputObjectSchema,
