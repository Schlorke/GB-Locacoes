...
export const AddressUpdateManySchema: z.ZodType<Prisma.AddressUpdateManyArgs> =
  z
    .object({
      data: AddressUpdateManyMutationInputObjectSchema,
      where: AddressWhereInputObjectSchema.optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.AddressUpdateManyArgs>

export const AddressUpdateManyZodSchema = z
  .object({
    data: AddressUpdateManyMutationInputObjectSchema,
    where: AddressWhereInputObjectSchema.optional(),
  })
