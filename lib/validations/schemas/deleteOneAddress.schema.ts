...
export const AddressDeleteOneSchema: z.ZodType<Prisma.AddressDeleteArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.AddressDeleteArgs>

export const AddressDeleteOneZodSchema = z
  .object({
    select: AddressSelectObjectSchema.optional(),
    include: AddressIncludeObjectSchema.optional(),
    where: AddressWhereUniqueInputObjectSchema,
