...
export const CartFindUniqueOrThrowSchema: z.ZodType<Prisma.CartFindUniqueOrThrowArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CartFindUniqueOrThrowArgs>

export const CartFindUniqueOrThrowZodSchema = z
  .object({
    select: CartSelectObjectSchema.optional(),
    include: CartIncludeObjectSchema.optional(),
    where: CartWhereUniqueInputObjectSchema,
