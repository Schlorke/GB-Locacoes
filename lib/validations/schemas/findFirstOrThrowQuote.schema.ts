...
export const QuoteFindFirstOrThrowSelectSchema: z.ZodType<Prisma.QuoteSelect> = z.object({
...
export const QuoteFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    phone: z.boolean().optional(),
...
export const QuoteFindFirstOrThrowSchema: z.ZodType<Prisma.QuoteFindFirstOrThrowArgs> = z.object({ select: QuoteFindFirstOrThrowSelectSchema.optional(), include: QuoteIncludeObjectSchema.optional(), orderBy: z.union([QuoteOrderByWithRelationInputObjectSchema, QuoteOrderByWithRelationInputObjectSchema.array()]).optional(), where: QuoteWhereInputObjectSchema.optional(), cursor: QuoteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([QuoteScalarFieldEnumSchema, QuoteScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.QuoteFindFirstOrThrowArgs>;

export const QuoteFindFirstOrThrowZodSchema = z.object({ select: QuoteFindFirstOrThrowSelectSchema.optional(), include: QuoteIncludeObjectSchema.optional(), orderBy: z.union([QuoteOrderByWithRelationInputObjectSchema, QuoteOrderByWithRelationInputObjectSchema.array()]).optional(), where: QuoteWhereInputObjectSchema.optional(), cursor: QuoteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([QuoteScalarFieldEnumSchema, QuoteScalarFieldEnumSchema.array()]).optional() }).strict();