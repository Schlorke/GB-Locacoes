...
export const QuoteFindFirstOrThrowSelectSchema: z.ZodType<Prisma.QuoteSelect, Prisma.QuoteSelect> = z.object({
...
export const QuoteFindFirstOrThrowSchema: z.ZodType<Prisma.QuoteFindFirstOrThrowArgs, Prisma.QuoteFindFirstOrThrowArgs> = z.object({ select: QuoteFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => QuoteIncludeObjectSchema.optional()), orderBy: z.union([QuoteOrderByWithRelationInputObjectSchema, QuoteOrderByWithRelationInputObjectSchema.array()]).optional(), where: QuoteWhereInputObjectSchema.optional(), cursor: QuoteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([QuoteScalarFieldEnumSchema, QuoteScalarFieldEnumSchema.array()]).optional() }).strict();
