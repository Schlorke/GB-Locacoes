...
export const SettingUpdateManySchema: z.ZodType<Prisma.SettingUpdateManyArgs> =
  z
    .object({
      data: SettingUpdateManyMutationInputObjectSchema,
      where: SettingWhereInputObjectSchema.optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.SettingUpdateManyArgs>

export const SettingUpdateManyZodSchema = z
  .object({
    data: SettingUpdateManyMutationInputObjectSchema,
    where: SettingWhereInputObjectSchema.optional(),
  })
