...
export const EquipmentFindUniqueSchema: z.ZodType<Prisma.EquipmentFindUniqueArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.EquipmentFindUniqueArgs>

export const EquipmentFindUniqueZodSchema = z
  .object({
    select: EquipmentSelectObjectSchema.optional(),
    include: EquipmentIncludeObjectSchema.optional(),
    where: EquipmentWhereUniqueInputObjectSchema,
