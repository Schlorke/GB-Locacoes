...
export const rental_itemsDeleteOneSchema: z.ZodType<Prisma.rental_itemsDeleteArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.rental_itemsDeleteArgs>

export const rental_itemsDeleteOneZodSchema = z
  .object({
    select: rental_itemsSelectObjectSchema.optional(),
    include: rental_itemsIncludeObjectSchema.optional(),
    where: rental_itemsWhereUniqueInputObjectSchema,
