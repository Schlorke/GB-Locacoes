...
export const CategoryCreateManySchema: z.ZodType<Prisma.CategoryCreateManyArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as unknown as z.ZodType<Prisma.CategoryCreateManyArgs>

export const CategoryCreateManyZodSchema = z
  .object({
    data: z.union([
      CategoryCreateManyInputObjectSchema,
      z.array(CategoryCreateManyInputObjectSchema),
