...
export const SettingUpdateOneSchema: z.ZodType<Prisma.SettingUpdateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.SettingUpdateArgs>

export const SettingUpdateOneZodSchema = z
  .object({
    select: SettingSelectObjectSchema.optional(),
    data: z.union([
      SettingUpdateInputObjectSchema,
