...
export const CategoryDeleteOneSchema: z.ZodType<Prisma.CategoryDeleteArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CategoryDeleteArgs>

export const CategoryDeleteOneZodSchema = z
  .object({
    select: CategorySelectObjectSchema.optional(),
    include: CategoryIncludeObjectSchema.optional(),
    where: CategoryWhereUniqueInputObjectSchema,
