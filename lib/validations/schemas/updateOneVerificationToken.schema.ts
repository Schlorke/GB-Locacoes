...
export const VerificationTokenUpdateOneSchema: z.ZodType<Prisma.VerificationTokenUpdateArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenUpdateArgs>

export const VerificationTokenUpdateOneZodSchema = z
  .object({
    select: VerificationTokenSelectObjectSchema.optional(),
    data: z.union([
      VerificationTokenUpdateInputObjectSchema,
