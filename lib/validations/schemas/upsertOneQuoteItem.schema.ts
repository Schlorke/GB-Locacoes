...
export const QuoteItemUpsertOneSchema: z.ZodType<Prisma.QuoteItemUpsertArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.QuoteItemUpsertArgs>

export const QuoteItemUpsertOneZodSchema = z
  .object({
    select: QuoteItemSelectObjectSchema.optional(),
    include: QuoteItemIncludeObjectSchema.optional(),
    where: QuoteItemWhereUniqueInputObjectSchema,
