...
export const CategoryFindUniqueOrThrowSchema: z.ZodType<Prisma.CategoryFindUniqueOrThrowArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CategoryFindUniqueOrThrowArgs>

export const CategoryFindUniqueOrThrowZodSchema = z
  .object({
    select: CategorySelectObjectSchema.optional(),
    include: CategoryIncludeObjectSchema.optional(),
    where: CategoryWhereUniqueInputObjectSchema,
