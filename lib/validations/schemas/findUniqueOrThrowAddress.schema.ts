...
export const AddressFindUniqueOrThrowSchema: z.ZodType<Prisma.AddressFindUniqueOrThrowArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.AddressFindUniqueOrThrowArgs>

export const AddressFindUniqueOrThrowZodSchema = z
  .object({
    select: AddressSelectObjectSchema.optional(),
    include: AddressIncludeObjectSchema.optional(),
    where: AddressWhereUniqueInputObjectSchema,
