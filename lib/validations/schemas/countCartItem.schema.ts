...
export const CartItemCountSchema: z.ZodType<Prisma.CartItemCountArgs> = z
  .object({
    orderBy: z
      .union([
  ...
  .strict() as unknown as z.ZodType<Prisma.CartItemCountArgs>

export const CartItemCountZodSchema = z
  .object({
    orderBy: z
      .union([
        CartItemOrderByWithRelationInputObjectSchema,
