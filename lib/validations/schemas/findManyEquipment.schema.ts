...
export const EquipmentFindManySelectSchema: z.ZodType<Prisma.EquipmentSelect> =
  z
    .object({
...
export const EquipmentFindManySchema: z.ZodType<Prisma.EquipmentFindManyArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.EquipmentFindManyArgs>
