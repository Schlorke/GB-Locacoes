...
export const EquipmentFindManySelectSchema: z.ZodType<Prisma.EquipmentSelect> = z.object({
...
export const EquipmentFindManySchema: z.ZodType<Prisma.EquipmentFindManyArgs> = z.object({ select: EquipmentFindManySelectSchema.optional(), include: EquipmentIncludeObjectSchema.optional(), orderBy: z.union([EquipmentOrderByWithRelationInputObjectSchema, EquipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EquipmentWhereInputObjectSchema.optional(), cursor: EquipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EquipmentScalarFieldEnumSchema, EquipmentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EquipmentFindManyArgs>;

export const EquipmentFindManyZodSchema = z.object({ select: EquipmentFindManySelectSchema.optional(), include: EquipmentIncludeObjectSchema.optional(), orderBy: z.union([EquipmentOrderByWithRelationInputObjectSchema, EquipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EquipmentWhereInputObjectSchema.optional(), cursor: EquipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EquipmentScalarFieldEnumSchema, EquipmentScalarFieldEnumSchema.array()]).optional() }).strict();