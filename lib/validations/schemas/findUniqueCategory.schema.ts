...
export const CategoryFindUniqueSchema: z.ZodType<Prisma.CategoryFindUniqueArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CategoryFindUniqueArgs>

export const CategoryFindUniqueZodSchema = z
  .object({
    select: CategorySelectObjectSchema.optional(),
    include: CategoryIncludeObjectSchema.optional(),
    where: CategoryWhereUniqueInputObjectSchema,
