...
export const rental_itemsFindManySelectSchema: z.ZodType<Prisma.rental_itemsSelect, Prisma.rental_itemsSelect> = z.object({
...
export const rental_itemsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    rentalid: z.boolean().optional(),
    equipmentid: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const rental_itemsFindManySchema: z.ZodType<Prisma.rental_itemsFindManyArgs, Prisma.rental_itemsFindManyArgs> = z.object({ select: rental_itemsFindManySelectSchema.optional(), include: z.lazy(() => rental_itemsIncludeObjectSchema.optional()), orderBy: z.union([rental_itemsOrderByWithRelationInputObjectSchema, rental_itemsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rental_itemsWhereInputObjectSchema.optional(), cursor: rental_itemsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([rental_itemsScalarFieldEnumSchema, rental_itemsScalarFieldEnumSchema.array()]).optional() }).strict();
