...
export const rental_itemsFindManySelectSchema: z.ZodType<Prisma.rental_itemsSelect> = z.object({
...
export const rental_itemsFindManySchema: z.ZodType<Prisma.rental_itemsFindManyArgs> = z.object({ select: rental_itemsFindManySelectSchema.optional(), include: rental_itemsIncludeObjectSchema.optional(), orderBy: z.union([rental_itemsOrderByWithRelationInputObjectSchema, rental_itemsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rental_itemsWhereInputObjectSchema.optional(), cursor: rental_itemsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RentalItemsScalarFieldEnumSchema, RentalItemsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.rental_itemsFindManyArgs>;

export const rental_itemsFindManyZodSchema = z.object({ select: rental_itemsFindManySelectSchema.optional(), include: rental_itemsIncludeObjectSchema.optional(), orderBy: z.union([rental_itemsOrderByWithRelationInputObjectSchema, rental_itemsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rental_itemsWhereInputObjectSchema.optional(), cursor: rental_itemsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RentalItemsScalarFieldEnumSchema, RentalItemsScalarFieldEnumSchema.array()]).optional() }).strict();