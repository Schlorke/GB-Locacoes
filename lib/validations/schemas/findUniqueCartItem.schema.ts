...
export const CartItemFindUniqueSchema: z.ZodType<Prisma.CartItemFindUniqueArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CartItemFindUniqueArgs>

export const CartItemFindUniqueZodSchema = z
  .object({
    select: CartItemSelectObjectSchema.optional(),
    include: CartItemIncludeObjectSchema.optional(),
    where: CartItemWhereUniqueInputObjectSchema,
