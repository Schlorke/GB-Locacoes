...
export const QuoteItemCountSchema: z.ZodType<Prisma.QuoteItemCountArgs> = z
  .object({
    orderBy: z
      .union([
  ...
  .strict() as unknown as z.ZodType<Prisma.QuoteItemCountArgs>

export const QuoteItemCountZodSchema = z
  .object({
    orderBy: z
      .union([
        QuoteItemOrderByWithRelationInputObjectSchema,
