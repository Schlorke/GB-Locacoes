...
export const rental_itemsCreateManySchema: z.ZodType<Prisma.rental_itemsCreateManyArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as unknown as z.ZodType<Prisma.rental_itemsCreateManyArgs>

export const rental_itemsCreateManyZodSchema = z
  .object({
    data: z.union([
      rental_itemsCreateManyInputObjectSchema,
      z.array(rental_itemsCreateManyInputObjectSchema),
