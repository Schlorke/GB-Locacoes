...
export const CartItemUpsertOneSchema: z.ZodType<Prisma.CartItemUpsertArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CartItemUpsertArgs>

export const CartItemUpsertOneZodSchema = z
  .object({
    select: CartItemSelectObjectSchema.optional(),
    include: CartItemIncludeObjectSchema.optional(),
    where: CartItemWhereUniqueInputObjectSchema,
