...
export const VerificationTokenFindFirstOrThrowSelectSchema: z.ZodType<Prisma.VerificationTokenSelect> =
  z
    .object({
...
export const VerificationTokenFindFirstOrThrowSelectZodSchema = z
  .object({
    identifier: z.boolean().optional(),
    token: z.boolean().optional(),
    expires: z.boolean().optional(),
...
export const VerificationTokenFindFirstOrThrowSchema: z.ZodType<Prisma.VerificationTokenFindFirstOrThrowArgs> =
  z
    .object({
      select: VerificationTokenFindFirstOrThrowSelectSchema.optional(),
      orderBy: z
        .union([
      ...
      distinct: z
        .union([
          z.nativeEnum(Prisma.VerificationTokenScalarFieldEnum),
          z.nativeEnum(Prisma.VerificationTokenScalarFieldEnum).array(),
        ])
        .optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenFindFirstOrThrowArgs>

export const VerificationTokenFindFirstOrThrowZodSchema = z
  .object({
    select: VerificationTokenFindFirstOrThrowSelectSchema.optional(),
    orderBy: z
      .union([
