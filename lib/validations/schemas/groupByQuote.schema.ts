...
export const QuoteGroupBySchema: z.ZodType<Prisma.QuoteGroupByArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.QuoteGroupByArgs>

export const QuoteGroupByZodSchema = z
  .object({
    where: QuoteWhereInputObjectSchema.optional(),
    orderBy: z
      .union([
