...
export const QuoteItemUpdateManyAndReturnSchema: z.ZodType<Prisma.QuoteItemUpdateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.QuoteItemUpdateManyAndReturnArgs>

export const QuoteItemUpdateManyAndReturnZodSchema = z
  .object({
    select: QuoteItemSelectObjectSchema.optional(),
    data: QuoteItemUpdateManyMutationInputObjectSchema,
    where: QuoteItemWhereInputObjectSchema.optional(),
