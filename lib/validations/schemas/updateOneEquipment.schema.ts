...
export const EquipmentUpdateOneSchema: z.ZodType<Prisma.EquipmentUpdateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.EquipmentUpdateArgs>

export const EquipmentUpdateOneZodSchema = z
  .object({
    select: EquipmentSelectObjectSchema.optional(),
    include: EquipmentIncludeObjectSchema.optional(),
    data: z.union([
