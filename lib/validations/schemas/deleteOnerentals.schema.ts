...
export const rentalsDeleteOneSchema: z.ZodType<Prisma.rentalsDeleteArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.rentalsDeleteArgs>

export const rentalsDeleteOneZodSchema = z
  .object({
    select: rentalsSelectObjectSchema.optional(),
    include: rentalsIncludeObjectSchema.optional(),
    where: rentalsWhereUniqueInputObjectSchema,
