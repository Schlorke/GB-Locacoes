...
export const CategoryCreateManyAndReturnSchema: z.ZodType<Prisma.CategoryCreateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CategoryCreateManyAndReturnArgs>

export const CategoryCreateManyAndReturnZodSchema = z
  .object({
    select: CategorySelectObjectSchema.optional(),
    data: z.union([
      CategoryCreateManyInputObjectSchema,
