...
export const AddressUpsertOneSchema: z.ZodType<Prisma.AddressUpsertArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.AddressUpsertArgs>

export const AddressUpsertOneZodSchema = z
  .object({
    select: AddressSelectObjectSchema.optional(),
    include: AddressIncludeObjectSchema.optional(),
    where: AddressWhereUniqueInputObjectSchema,
