...
export const CartCreateOneSchema: z.ZodType<Prisma.CartCreateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CartCreateArgs>

export const CartCreateOneZodSchema = z
  .object({
    select: CartSelectObjectSchema.optional(),
    include: CartIncludeObjectSchema.optional(),
    data: z.union([
