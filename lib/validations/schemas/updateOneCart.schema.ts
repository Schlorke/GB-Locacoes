...
export const CartUpdateOneSchema: z.ZodType<Prisma.CartUpdateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CartUpdateArgs>

export const CartUpdateOneZodSchema = z
  .object({
    select: CartSelectObjectSchema.optional(),
    include: CartIncludeObjectSchema.optional(),
    data: z.union([
