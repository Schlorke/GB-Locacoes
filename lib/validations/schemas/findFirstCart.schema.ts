...
export const CartFindFirstSelectSchema: z.ZodType<Prisma.CartSelect> = z
  .object({
...
export const CartFindFirstSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const CartFindFirstSchema: z.ZodType<Prisma.CartFindFirstArgs> = z
  .object({
    select: CartFindFirstSelectSchema.optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.CartFindFirstArgs>

export const CartFindFirstZodSchema = z
  .object({
    select: CartFindFirstSelectSchema.optional(),
    include: CartIncludeObjectSchema.optional(),
    orderBy: z
