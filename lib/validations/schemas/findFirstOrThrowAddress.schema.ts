...
export const AddressFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AddressSelect> =
  z
    .object({
...
export const AddressFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const AddressFindFirstOrThrowSchema: z.ZodType<Prisma.AddressFindFirstOrThrowArgs> =
  z
    .object({
      select: AddressFindFirstOrThrowSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.AddressFindFirstOrThrowArgs>

export const AddressFindFirstOrThrowZodSchema = z
  .object({
    select: AddressFindFirstOrThrowSelectSchema.optional(),
    include: AddressIncludeObjectSchema.optional(),
    orderBy: z
