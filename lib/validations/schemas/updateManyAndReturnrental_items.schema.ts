...
export const rental_itemsUpdateManyAndReturnSchema: z.ZodType<Prisma.rental_itemsUpdateManyAndReturnArgs> = z.object({ select: rental_itemsSelectObjectSchema.optional(), data: rental_itemsUpdateManyMutationInputObjectSchema, where: rental_itemsWhereInputObjectSchema.optional() }).strict() as unknown as z.ZodType<Prisma.rental_itemsUpdateManyAndReturnArgs>;

export const rental_itemsUpdateManyAndReturnZodSchema = z.object({ select: rental_itemsSelectObjectSchema.optional(), data: rental_itemsUpdateManyMutationInputObjectSchema, where: rental_itemsWhereInputObjectSchema.optional() }).strict();