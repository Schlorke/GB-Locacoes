...
export const EquipmentUpdateManySchema: z.ZodType<Prisma.EquipmentUpdateManyArgs> =
  z
    .object({
      data: EquipmentUpdateManyMutationInputObjectSchema,
      where: EquipmentWhereInputObjectSchema.optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.EquipmentUpdateManyArgs>

export const EquipmentUpdateManyZodSchema = z
  .object({
    data: EquipmentUpdateManyMutationInputObjectSchema,
    where: EquipmentWhereInputObjectSchema.optional(),
  })
