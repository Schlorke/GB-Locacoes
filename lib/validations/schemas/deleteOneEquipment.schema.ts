...
export const EquipmentDeleteOneSchema: z.ZodType<Prisma.EquipmentDeleteArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.EquipmentDeleteArgs>

export const EquipmentDeleteOneZodSchema = z
  .object({
    select: EquipmentSelectObjectSchema.optional(),
    include: EquipmentIncludeObjectSchema.optional(),
    where: EquipmentWhereUniqueInputObjectSchema,
