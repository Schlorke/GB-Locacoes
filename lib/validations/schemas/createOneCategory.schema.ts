...
export const CategoryCreateOneSchema: z.ZodType<Prisma.CategoryCreateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CategoryCreateArgs>

export const CategoryCreateOneZodSchema = z
  .object({
    select: CategorySelectObjectSchema.optional(),
    include: CategoryIncludeObjectSchema.optional(),
    data: z.union([
