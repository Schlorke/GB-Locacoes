...
export const rentalsFindManySelectSchema: z.ZodType<Prisma.rentalsSelect> = z
  .object({
...
export const rentalsFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    startdate: z.boolean().optional(),
    enddate: z.boolean().optional(),
...
export const rentalsFindManySchema: z.ZodType<Prisma.rentalsFindManyArgs> = z
  .object({
    select: rentalsFindManySelectSchema.optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.rentalsFindManyArgs>

export const rentalsFindManyZodSchema = z
  .object({
    select: rentalsFindManySelectSchema.optional(),
    include: rentalsIncludeObjectSchema.optional(),
    orderBy: z
