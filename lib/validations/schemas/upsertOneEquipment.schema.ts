...
export const EquipmentUpsertOneSchema: z.ZodType<Prisma.EquipmentUpsertArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.EquipmentUpsertArgs>

export const EquipmentUpsertOneZodSchema = z
  .object({
    select: EquipmentSelectObjectSchema.optional(),
    include: EquipmentIncludeObjectSchema.optional(),
    where: EquipmentWhereUniqueInputObjectSchema,
