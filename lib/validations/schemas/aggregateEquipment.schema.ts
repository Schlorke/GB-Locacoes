...
export const EquipmentAggregateSchema: z.ZodType<Prisma.EquipmentAggregateArgs> =
  z
    .object({
      orderBy: z
        .union([
    ...
    .strict() as unknown as z.ZodType<Prisma.EquipmentAggregateArgs>

export const EquipmentAggregateZodSchema = z
  .object({
    orderBy: z
      .union([
        EquipmentOrderByWithRelationInputObjectSchema,
