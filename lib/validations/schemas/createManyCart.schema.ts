...
export const CartCreateManySchema: z.ZodType<Prisma.CartCreateManyArgs> = z
  .object({
    data: z.union([
  ...
  .strict() as unknown as z.ZodType<Prisma.CartCreateManyArgs>

export const CartCreateManyZodSchema = z
  .object({
    data: z.union([
      CartCreateManyInputObjectSchema,
      z.array(CartCreateManyInputObjectSchema),
