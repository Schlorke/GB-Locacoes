...
export const rental_itemsUpdateManySchema = z.object({ data: rental_itemsUpdateManyMutationInputObjectSchema, where: rental_itemsWhereInputObjectSchema.optional()  })