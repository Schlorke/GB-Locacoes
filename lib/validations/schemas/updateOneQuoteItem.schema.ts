...
export const QuoteItemUpdateOneSchema: z.ZodType<Prisma.QuoteItemUpdateArgs> = z
  .object({
    select: QuoteItemSelectObjectSchema.optional(),
    include: QuoteItemIncludeObjectSchema.optional(),
    data: z.union([
      QuoteItemUpdateInputObjectSchema,
      QuoteItemUncheckedUpdateInputObjectSchema,
    ]),
    where: QuoteItemWhereUniqueInputObjectSchema,
  })
  .strict() as unknown as z.ZodType<Prisma.QuoteItemUpdateArgs>

export const QuoteItemUpdateOneZodSchema = z
  .object({
    select: QuoteItemSelectObjectSchema.optional(),
    include: QuoteItemIncludeObjectSchema.optional(),
    data: z.union([
