...
export const QuoteItemCreateOneSchema: z.ZodType<Prisma.QuoteItemCreateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.QuoteItemCreateArgs>

export const QuoteItemCreateOneZodSchema = z
  .object({
    select: QuoteItemSelectObjectSchema.optional(),
    include: QuoteItemIncludeObjectSchema.optional(),
    data: z.union([
