...
export const CartItemUpdateManyAndReturnSchema: z.ZodType<Prisma.CartItemUpdateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CartItemUpdateManyAndReturnArgs>

export const CartItemUpdateManyAndReturnZodSchema = z
  .object({
    select: CartItemSelectObjectSchema.optional(),
    data: CartItemUpdateManyMutationInputObjectSchema,
    where: CartItemWhereInputObjectSchema.optional(),
