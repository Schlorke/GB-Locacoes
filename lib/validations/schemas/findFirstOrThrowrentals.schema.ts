...
export const rentalsFindFirstOrThrowSchema: z.ZodType<Prisma.rentalsFindFirstOrThrowArgs> = z.object({ select: rentalsFindFirstOrThrowSelectSchema.optional(), include: rentalsIncludeObjectSchema.optional(), orderBy: z.union([rentalsOrderByWithRelationInputObjectSchema, rentalsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rentalsWhereInputObjectSchema.optional(), cursor: rentalsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RentalsScalarFieldEnumSchema, RentalsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.rentalsFindFirstOrThrowArgs>;

export const rentalsFindFirstOrThrowZodSchema = z.object({ select: rentalsFindFirstOrThrowSelectSchema.optional(), include: rentalsIncludeObjectSchema.optional(), orderBy: z.union([rentalsOrderByWithRelationInputObjectSchema, rentalsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rentalsWhereInputObjectSchema.optional(), cursor: rentalsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RentalsScalarFieldEnumSchema, RentalsScalarFieldEnumSchema.array()]).optional() }).strict();