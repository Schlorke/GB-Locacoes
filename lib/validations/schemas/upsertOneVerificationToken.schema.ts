...
export const VerificationTokenUpsertOneSchema: z.ZodType<Prisma.VerificationTokenUpsertArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenUpsertArgs>

export const VerificationTokenUpsertOneZodSchema = z
  .object({
    select: VerificationTokenSelectObjectSchema.optional(),
    where: VerificationTokenWhereUniqueInputObjectSchema,
    create: z.union([
