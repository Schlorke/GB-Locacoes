...
export const EquipmentUpdateManyAndReturnSchema: z.ZodType<Prisma.EquipmentUpdateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.EquipmentUpdateManyAndReturnArgs>

export const EquipmentUpdateManyAndReturnZodSchema = z
  .object({
    select: EquipmentSelectObjectSchema.optional(),
    data: EquipmentUpdateManyMutationInputObjectSchema,
    where: EquipmentWhereInputObjectSchema.optional(),
