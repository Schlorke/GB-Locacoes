...
export const rental_itemsFindFirstSchema: z.ZodType<Prisma.rental_itemsFindFirstArgs> = z.object({ select: rental_itemsFindFirstSelectSchema.optional(), include: rental_itemsIncludeObjectSchema.optional(), orderBy: z.union([rental_itemsOrderByWithRelationInputObjectSchema, rental_itemsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rental_itemsWhereInputObjectSchema.optional(), cursor: rental_itemsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RentalItemsScalarFieldEnumSchema, RentalItemsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.rental_itemsFindFirstArgs>;

export const rental_itemsFindFirstZodSchema = z.object({ select: rental_itemsFindFirstSelectSchema.optional(), include: rental_itemsIncludeObjectSchema.optional(), orderBy: z.union([rental_itemsOrderByWithRelationInputObjectSchema, rental_itemsOrderByWithRelationInputObjectSchema.array()]).optional(), where: rental_itemsWhereInputObjectSchema.optional(), cursor: rental_itemsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RentalItemsScalarFieldEnumSchema, RentalItemsScalarFieldEnumSchema.array()]).optional() }).strict();