...
export const VehicleFindFirstSelectSchema: z.ZodType<Prisma.VehicleSelect> = z.object({
...
export const VehicleFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    plate: z.boolean().optional(),
    brand: z.boolean().optional(),
    model: z.boolean().optional(),
