...
export const VerificationTokenFindManySelectSchema: z.ZodType<Prisma.VerificationTokenSelect> =
  z
    .object({
...
export const VerificationTokenFindManySelectZodSchema = z
  .object({
    identifier: z.boolean().optional(),
    token: z.boolean().optional(),
    expires: z.boolean().optional(),
...
export const VerificationTokenFindManySchema: z.ZodType<Prisma.VerificationTokenFindManyArgs> =
  z
    .object({
      select: VerificationTokenFindManySelectSchema.optional(),
      orderBy: z
        .union([
    ...
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenFindManyArgs>

export const VerificationTokenFindManyZodSchema = z
  .object({
    select: VerificationTokenFindManySelectSchema.optional(),
    orderBy: z
      .union([
