...
export const VerificationTokenFindManySelectSchema: z.ZodType<Prisma.VerificationTokenSelect, Prisma.VerificationTokenSelect> = z.object({
...
export const VerificationTokenFindManySchema: z.ZodType<Prisma.VerificationTokenFindManyArgs, Prisma.VerificationTokenFindManyArgs> = z.object({ select: VerificationTokenFindManySelectSchema.optional(),  orderBy: z.union([VerificationTokenOrderByWithRelationInputObjectSchema, VerificationTokenOrderByWithRelationInputObjectSchema.array()]).optional(), where: VerificationTokenWhereInputObjectSchema.optional(), cursor: VerificationTokenWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VerificationTokenScalarFieldEnumSchema, VerificationTokenScalarFieldEnumSchema.array()]).optional() }).strict();
