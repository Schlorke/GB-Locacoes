...
export const QuoteCreateManySchema: z.ZodType<Prisma.QuoteCreateManyArgs> = z
  .object({
    data: z.union([
  ...
  .strict() as unknown as z.ZodType<Prisma.QuoteCreateManyArgs>

export const QuoteCreateManyZodSchema = z
  .object({
    data: z.union([
      QuoteCreateManyInputObjectSchema,
      z.array(QuoteCreateManyInputObjectSchema),
