...
export const QuoteUpdateManySchema: z.ZodType<Prisma.QuoteUpdateManyArgs> = z
  .object({
    data: QuoteUpdateManyMutationInputObjectSchema,
    where: QuoteWhereInputObjectSchema.optional(),
  })
  .strict() as unknown as z.ZodType<Prisma.QuoteUpdateManyArgs>

export const QuoteUpdateManyZodSchema = z
  .object({
    data: QuoteUpdateManyMutationInputObjectSchema,
    where: QuoteWhereInputObjectSchema.optional(),
  })
