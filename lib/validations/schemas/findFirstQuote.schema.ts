...
export const QuoteFindFirstSelectSchema: z.ZodType<Prisma.QuoteSelect> = z
  .object({
...
export const QuoteFindFirstSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
...
export const QuoteFindFirstSchema: z.ZodType<Prisma.QuoteFindFirstArgs> = z
  .object({
    select: QuoteFindFirstSelectSchema.optional(),
    ...
    distinct: z
      .union([
        z.nativeEnum(Prisma.QuoteScalarFieldEnum),
        z.nativeEnum(Prisma.QuoteScalarFieldEnum).array(),
      ])
      .optional(),
  })
  .strict() as unknown as z.ZodType<Prisma.QuoteFindFirstArgs>

export const QuoteFindFirstZodSchema = z
  .object({
    select: QuoteFindFirstSelectSchema.optional(),
    include: z.lazy(() => QuoteIncludeObjectSchema.optional()),
    orderBy: z
