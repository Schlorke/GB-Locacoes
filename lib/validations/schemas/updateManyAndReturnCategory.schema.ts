...
export const CategoryUpdateManyAndReturnSchema: z.ZodType<Prisma.CategoryUpdateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CategoryUpdateManyAndReturnArgs>

export const CategoryUpdateManyAndReturnZodSchema = z
  .object({
    select: CategorySelectObjectSchema.optional(),
    data: CategoryUpdateManyMutationInputObjectSchema,
    where: CategoryWhereInputObjectSchema.optional(),
