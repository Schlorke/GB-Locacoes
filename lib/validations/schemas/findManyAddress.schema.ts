...
export const AddressFindManySelectSchema: z.ZodType<Prisma.AddressSelect> = z
  .object({
...
export const AddressFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const AddressFindManySchema: z.ZodType<Prisma.AddressFindManyArgs> = z
  .object({
    select: AddressFindManySelectSchema.optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.AddressFindManyArgs>

export const AddressFindManyZodSchema = z
  .object({
    select: AddressFindManySelectSchema.optional(),
    include: AddressIncludeObjectSchema.optional(),
    orderBy: z
