...
export const rental_itemsUpdateOneSchema: z.ZodType<Prisma.rental_itemsUpdateArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.rental_itemsUpdateArgs>

export const rental_itemsUpdateOneZodSchema = z
  .object({
    select: rental_itemsSelectObjectSchema.optional(),
    include: rental_itemsIncludeObjectSchema.optional(),
    data: z.union([
