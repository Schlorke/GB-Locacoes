...
export const rental_itemsUpdateOneSchema = z.object({ select: rental_itemsSelectObjectSchema.optional(), include: rental_itemsIncludeObjectSchema.optional(), data: z.union([rental_itemsUpdateInputObjectSchema, rental_itemsUncheckedUpdateInputObjectSchema]), where: rental_itemsWhereUniqueInputObjectSchema  })