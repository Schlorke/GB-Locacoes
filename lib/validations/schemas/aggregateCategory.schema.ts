...
export const CategoryAggregateSchema: z.ZodType<Prisma.CategoryAggregateArgs> =
  z
    .object({
      orderBy: z
        .union([
    ...
    .strict() as unknown as z.ZodType<Prisma.CategoryAggregateArgs>

export const CategoryAggregateZodSchema = z
  .object({
    orderBy: z
      .union([
        CategoryOrderByWithRelationInputObjectSchema,
