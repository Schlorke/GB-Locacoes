...
export const VehicleFindFirstOrThrowSelectSchema: z.ZodType<Prisma.VehicleSelect> = z.object({
...
export const VehicleFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    plate: z.boolean().optional(),
    brand: z.boolean().optional(),
    model: z.boolean().optional(),
...
export const VehicleFindFirstOrThrowSchema: z.ZodType<Prisma.VehicleFindFirstOrThrowArgs> = z.object({ select: VehicleFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([VehicleOrderByWithRelationInputObjectSchema, VehicleOrderByWithRelationInputObjectSchema.array()]).optional(), where: VehicleWhereInputObjectSchema.optional(), cursor: VehicleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VehicleScalarFieldEnumSchema, VehicleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VehicleFindFirstOrThrowArgs>;

export const VehicleFindFirstOrThrowZodSchema = z.object({ select: VehicleFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([VehicleOrderByWithRelationInputObjectSchema, VehicleOrderByWithRelationInputObjectSchema.array()]).optional(), where: VehicleWhereInputObjectSchema.optional(), cursor: VehicleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VehicleScalarFieldEnumSchema, VehicleScalarFieldEnumSchema.array()]).optional() }).strict();