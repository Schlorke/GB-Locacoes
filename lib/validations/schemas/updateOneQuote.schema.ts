...
export const QuoteUpdateOneSchema: z.ZodType<Prisma.QuoteUpdateArgs> = z.object({ select: QuoteSelectObjectSchema.optional(), include: QuoteIncludeObjectSchema.optional(), data: z.union([QuoteUpdateInputObjectSchema, QuoteUncheckedUpdateInputObjectSchema]), where: QuoteWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.QuoteUpdateArgs>;

export const QuoteUpdateOneZodSchema = z.object({ select: QuoteSelectObjectSchema.optional(), include: QuoteIncludeObjectSchema.optional(), data: z.union([QuoteUpdateInputObjectSchema, QuoteUncheckedUpdateInputObjectSchema]), where: QuoteWhereUniqueInputObjectSchema }).strict();