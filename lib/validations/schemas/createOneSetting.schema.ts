...
export const SettingCreateOneSchema: z.ZodType<Prisma.SettingCreateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.SettingCreateArgs>

export const SettingCreateOneZodSchema = z
  .object({
    select: SettingSelectObjectSchema.optional(),
    data: z.union([
      SettingCreateInputObjectSchema,
