...
export const CategoryUpsertOneSchema: z.ZodType<Prisma.CategoryUpsertArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CategoryUpsertArgs>

export const CategoryUpsertOneZodSchema = z
  .object({
    select: CategorySelectObjectSchema.optional(),
    include: CategoryIncludeObjectSchema.optional(),
    where: CategoryWhereUniqueInputObjectSchema,
