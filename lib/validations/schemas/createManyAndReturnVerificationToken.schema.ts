...
export const VerificationTokenCreateManyAndReturnSchema: z.ZodType<Prisma.VerificationTokenCreateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenCreateManyAndReturnArgs>

export const VerificationTokenCreateManyAndReturnZodSchema = z
  .object({
    select: VerificationTokenSelectObjectSchema.optional(),
    data: z.union([
      VerificationTokenCreateManyInputObjectSchema,
