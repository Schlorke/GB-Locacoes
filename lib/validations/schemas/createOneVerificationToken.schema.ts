...
export const VerificationTokenCreateOneSchema: z.ZodType<Prisma.VerificationTokenCreateArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenCreateArgs>

export const VerificationTokenCreateOneZodSchema = z
  .object({
    select: VerificationTokenSelectObjectSchema.optional(),
    data: z.union([
      VerificationTokenCreateInputObjectSchema,
