...
export const CartItemCreateOneSchema: z.ZodType<Prisma.CartItemCreateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CartItemCreateArgs>

export const CartItemCreateOneZodSchema = z
  .object({
    select: CartItemSelectObjectSchema.optional(),
    include: CartItemIncludeObjectSchema.optional(),
    data: z.union([
