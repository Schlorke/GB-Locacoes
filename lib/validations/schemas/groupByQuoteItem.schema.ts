...
export const QuoteItemGroupBySchema: z.ZodType<Prisma.QuoteItemGroupByArgs> = z
  .object({
    where: QuoteItemWhereInputObjectSchema.optional(),
    orderBy: z
      .union([
        QuoteItemOrderByWithAggregationInputObjectSchema,
        QuoteItemOrderByWithAggregationInputObjectSchema.array(),
      ])
      .optional(),
    having: QuoteItemScalarWhereWithAggregatesInputObjectSchema.optional(),
    take: z.number().optional(),
    skip: z.number().optional(),
    by: z.array(QuoteItemScalarFieldEnumSchema),
    _count: z
  ...
  .strict() as unknown as z.ZodType<Prisma.QuoteItemGroupByArgs>

export const QuoteItemGroupByZodSchema = z
  .object({
    where: QuoteItemWhereInputObjectSchema.optional(),
    orderBy: z
      .union([
