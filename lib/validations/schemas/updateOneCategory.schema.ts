...
export const CategoryUpdateOneSchema: z.ZodType<Prisma.CategoryUpdateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CategoryUpdateArgs>

export const CategoryUpdateOneZodSchema = z
  .object({
    select: CategorySelectObjectSchema.optional(),
    include: CategoryIncludeObjectSchema.optional(),
    data: z.union([
