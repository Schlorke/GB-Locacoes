...
export const rental_itemsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.rental_itemsSelect> =
  z
    .object({
...
export const rental_itemsFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    rentalid: z.boolean().optional(),
    equipmentid: z.boolean().optional(),
...
export const rental_itemsFindFirstOrThrowSchema: z.ZodType<Prisma.rental_itemsFindFirstOrThrowArgs> =
  z
    .object({
      select: rental_itemsFindFirstOrThrowSelectSchema.optional(),
      ...
      distinct: z
        .union([
          z.nativeEnum(Prisma.rental_itemsScalarFieldEnum),
          z.nativeEnum(Prisma.rental_itemsScalarFieldEnum).array(),
        ])
        .optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.rental_itemsFindFirstOrThrowArgs>

export const rental_itemsFindFirstOrThrowZodSchema = z
  .object({
    select: rental_itemsFindFirstOrThrowSelectSchema.optional(),
    include: z.lazy(() => rental_itemsIncludeObjectSchema.optional()),
    orderBy: z
