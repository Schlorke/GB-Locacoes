...
export const QuoteScalarFieldEnumSchema = z.enum(['id', 'name', 'email', 'phone', 'company', 'message', 'total', 'status', 'userId', 'createdAt', 'updatedAt', 'cep', 'cnpj', 'cpf', 'adminNotes', 'approvedAt', 'approvedBy', 'convertedToRentalId', 'deliveryAddress', 'deliveryFee', 'deliveryType', 'deposit', 'discount', 'endDate', 'finalTotal', 'internalNotes', 'pickupFee', 'priority', 'rejectedAt', 'rejectedBy', 'rejectionReason', 'startDate', 'subtotal', 'taxes', 'validUntil', 'originalTotal', 'priceAdjustmentReason', 'priceAdjustedAt', 'priceAdjustedBy', 'lateFee', 'lateFeeApproved', 'lateFeeApprovedAt', 'lateFeeApprovedBy', 'damages', 'misuse'])
