...
export const rentalsFindUniqueOrThrowSchema: z.ZodType<Prisma.rentalsFindUniqueOrThrowArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.rentalsFindUniqueOrThrowArgs>

export const rentalsFindUniqueOrThrowZodSchema = z
  .object({
    select: rentalsSelectObjectSchema.optional(),
    include: rentalsIncludeObjectSchema.optional(),
    where: rentalsWhereUniqueInputObjectSchema,
