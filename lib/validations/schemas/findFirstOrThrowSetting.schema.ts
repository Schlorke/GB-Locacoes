...
export const SettingFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SettingSelect> =
  z
    .object({
...
export const SettingFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    companyPhone: z.boolean().optional(),
    companyIconUrl: z.boolean().optional(),
...
export const SettingFindFirstOrThrowSchema: z.ZodType<Prisma.SettingFindFirstOrThrowArgs> =
  z
    .object({
      select: SettingFindFirstOrThrowSelectSchema.optional(),
      orderBy: z
        .union([
    ...
    .strict() as unknown as z.ZodType<Prisma.SettingFindFirstOrThrowArgs>

export const SettingFindFirstOrThrowZodSchema = z
  .object({
    select: SettingFindFirstOrThrowSelectSchema.optional(),
    orderBy: z
      .union([
