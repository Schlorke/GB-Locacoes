...
export const CategoryUpdateManySchema: z.ZodType<Prisma.CategoryUpdateManyArgs> =
  z
    .object({
      data: CategoryUpdateManyMutationInputObjectSchema,
      where: CategoryWhereInputObjectSchema.optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.CategoryUpdateManyArgs>

export const CategoryUpdateManyZodSchema = z
  .object({
    data: CategoryUpdateManyMutationInputObjectSchema,
    where: CategoryWhereInputObjectSchema.optional(),
  })
