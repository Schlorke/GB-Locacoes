...
export const DeliveryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.DeliverySelect> = z.object({
...
export const DeliveryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    rentalId: z.boolean().optional(),
    type: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const DeliveryFindFirstOrThrowSchema: z.ZodType<Prisma.DeliveryFindFirstOrThrowArgs> = z.object({ select: DeliveryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DeliveryIncludeObjectSchema.optional()), orderBy: z.union([DeliveryOrderByWithRelationInputObjectSchema, DeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeliveryWhereInputObjectSchema.optional(), cursor: DeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeliveryScalarFieldEnumSchema, DeliveryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DeliveryFindFirstOrThrowArgs>;

export const DeliveryFindFirstOrThrowZodSchema = z.object({ select: DeliveryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DeliveryIncludeObjectSchema.optional()), orderBy: z.union([DeliveryOrderByWithRelationInputObjectSchema, DeliveryOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeliveryWhereInputObjectSchema.optional(), cursor: DeliveryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeliveryScalarFieldEnumSchema, DeliveryScalarFieldEnumSchema.array()]).optional() }).strict();