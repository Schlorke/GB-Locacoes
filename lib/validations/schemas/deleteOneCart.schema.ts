...
export const CartDeleteOneSchema: z.ZodType<Prisma.CartDeleteArgs> = z
  .object({
    select: CartSelectObjectSchema.optional(),
    include: CartIncludeObjectSchema.optional(),
    where: CartWhereUniqueInputObjectSchema,
  })
  .strict() as unknown as z.ZodType<Prisma.CartDeleteArgs>

export const CartDeleteOneZodSchema = z
  .object({
    select: CartSelectObjectSchema.optional(),
    include: CartIncludeObjectSchema.optional(),
    where: CartWhereUniqueInputObjectSchema,
