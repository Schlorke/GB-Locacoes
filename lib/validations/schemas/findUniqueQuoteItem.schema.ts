...
export const QuoteItemFindUniqueSchema: z.ZodType<Prisma.QuoteItemFindUniqueArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.QuoteItemFindUniqueArgs>

export const QuoteItemFindUniqueZodSchema = z
  .object({
    select: QuoteItemSelectObjectSchema.optional(),
    include: QuoteItemIncludeObjectSchema.optional(),
    where: QuoteItemWhereUniqueInputObjectSchema,
