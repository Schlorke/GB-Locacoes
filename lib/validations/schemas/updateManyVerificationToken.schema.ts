...
export const VerificationTokenUpdateManySchema: z.ZodType<Prisma.VerificationTokenUpdateManyArgs> =
  z
    .object({
      data: VerificationTokenUpdateManyMutationInputObjectSchema,
      where: VerificationTokenWhereInputObjectSchema.optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenUpdateManyArgs>

export const VerificationTokenUpdateManyZodSchema = z
  .object({
    data: VerificationTokenUpdateManyMutationInputObjectSchema,
    where: VerificationTokenWhereInputObjectSchema.optional(),
  })
