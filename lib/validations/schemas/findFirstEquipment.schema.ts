...
export const EquipmentFindFirstSchema: z.ZodType<Prisma.EquipmentFindFirstArgs> = z.object({ select: EquipmentFindFirstSelectSchema.optional(), include: EquipmentIncludeObjectSchema.optional(), orderBy: z.union([EquipmentOrderByWithRelationInputObjectSchema, EquipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EquipmentWhereInputObjectSchema.optional(), cursor: EquipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EquipmentScalarFieldEnumSchema, EquipmentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EquipmentFindFirstArgs>;

export const EquipmentFindFirstZodSchema = z.object({ select: EquipmentFindFirstSelectSchema.optional(), include: EquipmentIncludeObjectSchema.optional(), orderBy: z.union([EquipmentOrderByWithRelationInputObjectSchema, EquipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EquipmentWhereInputObjectSchema.optional(), cursor: EquipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EquipmentScalarFieldEnumSchema, EquipmentScalarFieldEnumSchema.array()]).optional() }).strict();