...
export const EquipmentFindFirstSelectSchema: z.ZodType<Prisma.EquipmentSelect> =
  z
    .object({
...
export const EquipmentFindFirstSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const EquipmentFindFirstSchema: z.ZodType<Prisma.EquipmentFindFirstArgs> =
  z
    .object({
      select: EquipmentFindFirstSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.EquipmentFindFirstArgs>

export const EquipmentFindFirstZodSchema = z
  .object({
    select: EquipmentFindFirstSelectSchema.optional(),
    include: z.lazy(() => EquipmentIncludeObjectSchema.optional()),
    orderBy: z
