...
export const CartCreateManyAndReturnSchema: z.ZodType<Prisma.CartCreateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CartCreateManyAndReturnArgs>

export const CartCreateManyAndReturnZodSchema = z
  .object({
    select: CartSelectObjectSchema.optional(),
    data: z.union([
      CartCreateManyInputObjectSchema,
