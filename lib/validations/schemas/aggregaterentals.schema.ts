...
export const rentalsAggregateSchema: z.ZodType<Prisma.rentalsAggregateArgs> = z
  .object({
    orderBy: z
      .union([
  ...
  .strict() as unknown as z.ZodType<Prisma.rentalsAggregateArgs>

export const rentalsAggregateZodSchema = z
  .object({
    orderBy: z
      .union([
        rentalsOrderByWithRelationInputObjectSchema,
