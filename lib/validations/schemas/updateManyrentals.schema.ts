...
export const rentalsUpdateManySchema: z.ZodType<Prisma.rentalsUpdateManyArgs> =
  z
    .object({
      data: rentalsUpdateManyMutationInputObjectSchema,
      where: rentalsWhereInputObjectSchema.optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.rentalsUpdateManyArgs>

export const rentalsUpdateManyZodSchema = z
  .object({
    data: rentalsUpdateManyMutationInputObjectSchema,
    where: rentalsWhereInputObjectSchema.optional(),
  })
