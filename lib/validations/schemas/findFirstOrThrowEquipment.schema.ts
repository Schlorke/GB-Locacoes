...
export const EquipmentFindFirstOrThrowSchema: z.ZodType<Prisma.EquipmentFindFirstOrThrowArgs> = z.object({ select: EquipmentFindFirstOrThrowSelectSchema.optional(), include: EquipmentIncludeObjectSchema.optional(), orderBy: z.union([EquipmentOrderByWithRelationInputObjectSchema, EquipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EquipmentWhereInputObjectSchema.optional(), cursor: EquipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EquipmentScalarFieldEnumSchema, EquipmentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EquipmentFindFirstOrThrowArgs>;

export const EquipmentFindFirstOrThrowZodSchema = z.object({ select: EquipmentFindFirstOrThrowSelectSchema.optional(), include: EquipmentIncludeObjectSchema.optional(), orderBy: z.union([EquipmentOrderByWithRelationInputObjectSchema, EquipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EquipmentWhereInputObjectSchema.optional(), cursor: EquipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EquipmentScalarFieldEnumSchema, EquipmentScalarFieldEnumSchema.array()]).optional() }).strict();