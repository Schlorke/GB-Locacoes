...
export const CartAggregateSchema: z.ZodType<Prisma.CartAggregateArgs> = z
  .object({
    orderBy: z
      .union([
  ...
  .strict() as unknown as z.ZodType<Prisma.CartAggregateArgs>

export const CartAggregateZodSchema = z
  .object({
    orderBy: z
      .union([
        CartOrderByWithRelationInputObjectSchema,
