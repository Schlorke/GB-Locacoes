...
export const rental_itemsUpsertOneSchema: z.ZodType<Prisma.rental_itemsUpsertArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.rental_itemsUpsertArgs>

export const rental_itemsUpsertOneZodSchema = z
  .object({
    select: rental_itemsSelectObjectSchema.optional(),
    include: rental_itemsIncludeObjectSchema.optional(),
    where: rental_itemsWhereUniqueInputObjectSchema,
