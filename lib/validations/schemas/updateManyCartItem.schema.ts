...
export const CartItemUpdateManySchema: z.ZodType<Prisma.CartItemUpdateManyArgs> =
  z
    .object({
      data: CartItemUpdateManyMutationInputObjectSchema,
      where: CartItemWhereInputObjectSchema.optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.CartItemUpdateManyArgs>

export const CartItemUpdateManyZodSchema = z
  .object({
    data: CartItemUpdateManyMutationInputObjectSchema,
    where: CartItemWhereInputObjectSchema.optional(),
  })
