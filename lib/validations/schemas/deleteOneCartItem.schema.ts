...
export const CartItemDeleteOneSchema: z.ZodType<Prisma.CartItemDeleteArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CartItemDeleteArgs>

export const CartItemDeleteOneZodSchema = z
  .object({
    select: CartItemSelectObjectSchema.optional(),
    include: CartItemIncludeObjectSchema.optional(),
    where: CartItemWhereUniqueInputObjectSchema,
