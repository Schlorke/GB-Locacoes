...
export const rentalsCreateManySchema: z.ZodType<Prisma.rentalsCreateManyArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as unknown as z.ZodType<Prisma.rentalsCreateManyArgs>

export const rentalsCreateManyZodSchema = z
  .object({
    data: z.union([
      rentalsCreateManyInputObjectSchema,
      z.array(rentalsCreateManyInputObjectSchema),
