...
export const CategoryGroupBySchema: z.ZodType<Prisma.CategoryGroupByArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CategoryGroupByArgs>

export const CategoryGroupByZodSchema = z
  .object({
    where: CategoryWhereInputObjectSchema.optional(),
    orderBy: z
      .union([
