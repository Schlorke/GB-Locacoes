...
export const SettingCreateManySchema: z.ZodType<Prisma.SettingCreateManyArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as unknown as z.ZodType<Prisma.SettingCreateManyArgs>

export const SettingCreateManyZodSchema = z
  .object({
    data: z.union([
      SettingCreateManyInputObjectSchema,
      z.array(SettingCreateManyInputObjectSchema),
