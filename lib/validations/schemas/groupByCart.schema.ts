...
export const CartGroupBySchema: z.ZodType<Prisma.CartGroupByArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CartGroupByArgs>

export const CartGroupByZodSchema = z
  .object({
    where: CartWhereInputObjectSchema.optional(),
    orderBy: z
      .union([
