...
export const EquipmentCreateOneSchema: z.ZodType<Prisma.EquipmentCreateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.EquipmentCreateArgs>

export const EquipmentCreateOneZodSchema = z
  .object({
    select: EquipmentSelectObjectSchema.optional(),
    include: EquipmentIncludeObjectSchema.optional(),
    data: z.union([
