...
export const VerificationTokenFindFirstSelectSchema: z.ZodType<Prisma.VerificationTokenSelect, Prisma.VerificationTokenSelect> = z.object({
...
export const VerificationTokenFindFirstSchema: z.ZodType<Prisma.VerificationTokenFindFirstArgs, Prisma.VerificationTokenFindFirstArgs> = z.object({ select: VerificationTokenFindFirstSelectSchema.optional(),  orderBy: z.union([VerificationTokenOrderByWithRelationInputObjectSchema, VerificationTokenOrderByWithRelationInputObjectSchema.array()]).optional(), where: VerificationTokenWhereInputObjectSchema.optional(), cursor: VerificationTokenWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VerificationTokenScalarFieldEnumSchema, VerificationTokenScalarFieldEnumSchema.array()]).optional() }).strict();
