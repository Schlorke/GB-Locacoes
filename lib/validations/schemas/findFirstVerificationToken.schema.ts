...
export const VerificationTokenFindFirstSelectSchema: z.ZodType<Prisma.VerificationTokenSelect> =
  z
    .object({
...
export const VerificationTokenFindFirstSelectZodSchema = z
  .object({
    identifier: z.boolean().optional(),
    token: z.boolean().optional(),
    expires: z.boolean().optional(),
...
export const VerificationTokenFindFirstSchema: z.ZodType<Prisma.VerificationTokenFindFirstArgs> =
  z
    .object({
      select: VerificationTokenFindFirstSelectSchema.optional(),
      orderBy: z
        .union([
    ...
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenFindFirstArgs>

export const VerificationTokenFindFirstZodSchema = z
  .object({
    select: VerificationTokenFindFirstSelectSchema.optional(),
    orderBy: z
      .union([
