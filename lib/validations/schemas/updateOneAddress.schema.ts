...
export const AddressUpdateOneSchema: z.ZodType<Prisma.AddressUpdateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.AddressUpdateArgs>

export const AddressUpdateOneZodSchema = z
  .object({
    select: AddressSelectObjectSchema.optional(),
    include: AddressIncludeObjectSchema.optional(),
    data: z.union([
