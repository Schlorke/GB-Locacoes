...
export const CartUpdateManyAndReturnSchema: z.ZodType<Prisma.CartUpdateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.CartUpdateManyAndReturnArgs>

export const CartUpdateManyAndReturnZodSchema = z
  .object({
    select: CartSelectObjectSchema.optional(),
    data: CartUpdateManyMutationInputObjectSchema,
    where: CartWhereInputObjectSchema.optional(),
