...
export const EquipmentCreateWithoutCategoryInputObjectSchema: z.ZodType<
  Prisma.EquipmentCreateWithoutCategoryInput,
  Prisma.EquipmentCreateWithoutCategoryInput
> = z
  .object({
  ...
  .strict()
export const EquipmentCreateWithoutCategoryInputObjectZodSchema = z
  .object({
    id: z.string().optional(),
    name: z.string(),
    description: z.string().optional().nullable(),
