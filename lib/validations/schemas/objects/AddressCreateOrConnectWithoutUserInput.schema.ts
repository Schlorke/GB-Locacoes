...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressCreateOrConnectWithoutUserInputObjectSchema: z.ZodType<Prisma.AddressCreateOrConnectWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressCreateOrConnectWithoutUserInput>
export const AddressCreateOrConnectWithoutUserInputObjectZodSchema =
  makeSchema()
