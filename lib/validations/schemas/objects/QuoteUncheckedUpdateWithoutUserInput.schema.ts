...
export const QuoteUncheckedUpdateWithoutUserInputObjectSchema: z.ZodType<
  Prisma.QuoteUncheckedUpdateWithoutUserInput,
  Prisma.QuoteUncheckedUpdateWithoutUserInput
> = z
  .object({
    id: z
  ...
  .strict()
export const QuoteUncheckedUpdateWithoutUserInputObjectZodSchema = z
  .object({
    id: z
      .union([
        z.string(),
