...
export const SessionUpdateWithWhereUniqueWithoutUserInputObjectSchema: z.ZodType<
...
> = z
  ...
  .strict()
export const SessionUpdateWithWhereUniqueWithoutUserInputObjectZodSchema = z
  .object({
    where: z.lazy(() => SessionWhereUniqueInputObjectSchema),
    data: z.union([
      z.lazy(() => SessionUpdateWithoutUserInputObjectSchema),
