...
const addressscalarwherewithaggregatesinputSchema = z.object({
  ...
  complement: z.union([z.lazy(() => StringNullableWithAggregatesFilterObjectSchema), z.string()]).optional().nullable(),
  neighborhood: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema), z.string()]).optional(),
