...
export const rentalsCreateOrConnectWithoutRental_itemsInputObjectSchema: z.ZodType<
  Prisma.rentalsCreateOrConnectWithoutRental_itemsInput,
  Prisma.rentalsCreateOrConnectWithoutRental_itemsInput
> = z
  .object({
  ...
  .strict()
export const rentalsCreateOrConnectWithoutRental_itemsInputObjectZodSchema = z
  .object({
    where: z.lazy(() => rentalsWhereUniqueInputObjectSchema),
    create: z.union([
      z.lazy(() => rentalsCreateWithoutRental_itemsInputObjectSchema),
