...
export const QuoteUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<
  Prisma.QuoteUpdateManyWithoutUserNestedInput,
  Prisma.QuoteUpdateManyWithoutUserNestedInput
> = z
  .object({
    create: z
  ...
  .strict()
export const QuoteUpdateManyWithoutUserNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteCreateWithoutUserInputObjectSchema),
