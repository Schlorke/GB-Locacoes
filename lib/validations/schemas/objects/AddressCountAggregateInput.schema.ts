...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressCountAggregateInputObjectSchema: z.ZodType<Prisma.AddressCountAggregateInputType> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressCountAggregateInputType>
