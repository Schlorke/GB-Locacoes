...
export const UserUpdateToOneWithWhereWithoutSessionsInputObjectSchema: z.ZodType<
...
> = z
  ...
  .strict()
export const UserUpdateToOneWithWhereWithoutSessionsInputObjectZodSchema = z
  .object({
    where: z.lazy(() => UserWhereInputObjectSchema).optional(),
    data: z.union([
      z.lazy(() => UserUpdateWithoutSessionsInputObjectSchema),
