...
export const QuoteCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<
  Prisma.QuoteCreateNestedManyWithoutUserInput,
  Prisma.QuoteCreateNestedManyWithoutUserInput
> = z
  .object({
    create: z
  ...
  .strict()
export const QuoteCreateNestedManyWithoutUserInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteCreateWithoutUserInputObjectSchema),
