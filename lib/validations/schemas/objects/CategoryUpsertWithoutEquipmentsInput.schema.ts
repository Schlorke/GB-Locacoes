...
export const CategoryUpsertWithoutEquipmentsInputObjectSchema: z.ZodType<
  Prisma.CategoryUpsertWithoutEquipmentsInput,
  Prisma.CategoryUpsertWithoutEquipmentsInput
> = z
  .object({
    update: z.union([
  ...
  .strict()
export const CategoryUpsertWithoutEquipmentsInputObjectZodSchema = z
  .object({
    update: z.union([
      z.lazy(() => CategoryUpdateWithoutEquipmentsInputObjectSchema),
      z.lazy(() => CategoryUncheckedUpdateWithoutEquipmentsInputObjectSchema),
