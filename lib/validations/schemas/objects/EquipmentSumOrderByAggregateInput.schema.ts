...
const makeSchema = () =>
  z
    ...
    .strict()
export const EquipmentSumOrderByAggregateInputObjectSchema: z.ZodType<Prisma.EquipmentSumOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EquipmentSumOrderByAggregateInput>
