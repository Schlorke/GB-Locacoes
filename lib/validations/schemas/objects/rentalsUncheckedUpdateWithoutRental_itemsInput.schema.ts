...
export const rentalsUncheckedUpdateWithoutRental_itemsInputObjectSchema: z.ZodType<Prisma.rentalsUncheckedUpdateWithoutRental_itemsInput, Prisma.rentalsUncheckedUpdateWithoutRental_itemsInput> = z.object({
...
export const rentalsUncheckedUpdateWithoutRental_itemsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  startdate: z.union([z.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
  enddate: z.union([z.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
  total: z.union([z.number(), z.lazy(() => DecimalFieldUpdateOperationsInputObjectSchema)]).optional(),
