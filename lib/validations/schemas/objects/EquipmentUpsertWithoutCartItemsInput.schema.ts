  ...
  z
    .object({
      ...
      create: z.union([
        ...
        z.lazy(() => EquipmentUncheckedCreateWithoutCartItemsInputObjectSchema),
      ]),
      where: z.lazy(() => EquipmentWhereInputObjectSchema).optional(),
    })
    .strict()
export const EquipmentUpsertWithoutCartItemsInputObjectSchema: z.ZodType<Prisma.EquipmentUpsertWithoutCartItemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EquipmentUpsertWithoutCartItemsInput>
