...
export const EquipmentUncheckedCreateWithoutCategoryInputObjectSchema: z.ZodType<
  Prisma.EquipmentUncheckedCreateWithoutCategoryInput,
  Prisma.EquipmentUncheckedCreateWithoutCategoryInput
> = z
  .object({
  ...
  .strict()
export const EquipmentUncheckedCreateWithoutCategoryInputObjectZodSchema = z
  .object({
    id: z.string().optional(),
    name: z.string(),
    description: z.string().optional().nullable(),
