...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartCreateOrConnectWithoutItemsInputObjectSchema: z.ZodType<Prisma.CartCreateOrConnectWithoutItemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartCreateOrConnectWithoutItemsInput>
