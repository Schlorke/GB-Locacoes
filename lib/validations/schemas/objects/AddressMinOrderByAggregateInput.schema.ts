...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressMinOrderByAggregateInputObjectSchema: z.ZodType<Prisma.AddressMinOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressMinOrderByAggregateInput>
