...
export const QuoteItemIncludeObjectSchema: z.ZodType<Prisma.QuoteItemInclude, Prisma.QuoteItemInclude> = z.object({
...
export const QuoteItemIncludeObjectZodSchema = z.object({
  equipment: z.union([z.boolean(), z.lazy(() => EquipmentArgsObjectSchema)]).optional(),
  quote: z.union([z.boolean(), z.lazy(() => QuoteArgsObjectSchema)]).optional()
}).strict();
