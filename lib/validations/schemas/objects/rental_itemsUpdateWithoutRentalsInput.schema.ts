...
export const rental_itemsUpdateWithoutRentalsInputObjectSchema: z.ZodType<
  Prisma.rental_itemsUpdateWithoutRentalsInput,
  Prisma.rental_itemsUpdateWithoutRentalsInput
> = z
  .object({
    quantity: z
  ...
  .strict()
export const rental_itemsUpdateWithoutRentalsInputObjectZodSchema = z
  .object({
    quantity: z
      .union([
        z.number().int(),
