...
const makeSchema = () =>
  z
    ...
    .strict()
export const rental_itemsUpdateManyWithWhereWithoutEquipmentsInputObjectSchema: z.ZodType<Prisma.rental_itemsUpdateManyWithWhereWithoutEquipmentsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.rental_itemsUpdateManyWithWhereWithoutEquipmentsInput>
