...
export const rentalsUpdateManyWithWhereWithoutUsersInputObjectSchema: z.ZodType<
  Prisma.rentalsUpdateManyWithWhereWithoutUsersInput,
  Prisma.rentalsUpdateManyWithWhereWithoutUsersInput
> = z
  .object({
  ...
  .strict()
export const rentalsUpdateManyWithWhereWithoutUsersInputObjectZodSchema = z
  .object({
    where: z.lazy(() => rentalsScalarWhereInputObjectSchema),
    data: z.union([
      z.lazy(() => rentalsUpdateManyMutationInputObjectSchema),
