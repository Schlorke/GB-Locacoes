...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserCreateNestedOneWithoutAddressesInputObjectSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutAddressesInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserCreateNestedOneWithoutAddressesInput>
export const UserCreateNestedOneWithoutAddressesInputObjectZodSchema =
  makeSchema()
