...
const makeSchema = () =>
  z
    ...
    .strict()
export const SettingCreateManyInputObjectSchema: z.ZodType<Prisma.SettingCreateManyInput> =
  makeSchema() as unknown as z.ZodType<Prisma.SettingCreateManyInput>
