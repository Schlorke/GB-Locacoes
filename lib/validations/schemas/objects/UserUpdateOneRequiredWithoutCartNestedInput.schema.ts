...
const makeSchema = () =>
  z
    .object({
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutCartInputObjectSchema),
    ...
    .strict()
export const UserUpdateOneRequiredWithoutCartNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutCartNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpdateOneRequiredWithoutCartNestedInput>
export const UserUpdateOneRequiredWithoutCartNestedInputObjectZodSchema =
  makeSchema()
