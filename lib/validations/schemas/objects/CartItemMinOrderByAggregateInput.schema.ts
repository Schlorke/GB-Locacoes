...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartItemMinOrderByAggregateInputObjectSchema: z.ZodType<Prisma.CartItemMinOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemMinOrderByAggregateInput>
