...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressMaxAggregateInputObjectSchema: z.ZodType<Prisma.AddressMaxAggregateInputType> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressMaxAggregateInputType>
