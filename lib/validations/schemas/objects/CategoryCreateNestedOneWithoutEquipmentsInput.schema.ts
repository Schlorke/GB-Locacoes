...
const makeSchema = () =>
  z
    ...
    .strict()
export const CategoryCreateNestedOneWithoutEquipmentsInputObjectSchema: z.ZodType<Prisma.CategoryCreateNestedOneWithoutEquipmentsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CategoryCreateNestedOneWithoutEquipmentsInput>
export const CategoryCreateNestedOneWithoutEquipmentsInputObjectZodSchema =
  makeSchema()
