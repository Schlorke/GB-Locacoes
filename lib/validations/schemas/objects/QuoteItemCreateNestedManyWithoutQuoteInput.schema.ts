...
export const QuoteItemCreateNestedManyWithoutQuoteInputObjectSchema: z.ZodType<
  Prisma.QuoteItemCreateNestedManyWithoutQuoteInput,
  Prisma.QuoteItemCreateNestedManyWithoutQuoteInput
> = z
  .object({
    create: z
  ...
  .strict()
export const QuoteItemCreateNestedManyWithoutQuoteInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteItemCreateWithoutQuoteInputObjectSchema),
