...
const settingwhereinputSchema = z
  .object({
    AND: z
      .union([
  ...
  .strict()
export const SettingWhereInputObjectSchema: z.ZodType<Prisma.SettingWhereInput> =
  settingwhereinputSchema as unknown as z.ZodType<Prisma.SettingWhereInput>
