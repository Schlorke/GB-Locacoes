...
const equipmentwhereinputSchema = z
  .object({
    AND: z
      .union([
        z.lazy(() => EquipmentWhereInputObjectSchema),
        z.lazy(() => EquipmentWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => EquipmentWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const EquipmentWhereInputObjectSchema: z.ZodType<Prisma.EquipmentWhereInput> =
  equipmentwhereinputSchema as unknown as z.ZodType<Prisma.EquipmentWhereInput>
