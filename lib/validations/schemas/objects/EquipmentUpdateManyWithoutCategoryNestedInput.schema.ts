...
export const EquipmentUpdateManyWithoutCategoryNestedInputObjectSchema: z.ZodType<
  Prisma.EquipmentUpdateManyWithoutCategoryNestedInput,
  Prisma.EquipmentUpdateManyWithoutCategoryNestedInput
> = z
  .object({
    create: z
  ...
  .strict()
export const EquipmentUpdateManyWithoutCategoryNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => EquipmentCreateWithoutCategoryInputObjectSchema),
