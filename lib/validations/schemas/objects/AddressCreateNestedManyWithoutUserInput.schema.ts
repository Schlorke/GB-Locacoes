...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<Prisma.AddressCreateNestedManyWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressCreateNestedManyWithoutUserInput>
export const AddressCreateNestedManyWithoutUserInputObjectZodSchema =
  makeSchema()
