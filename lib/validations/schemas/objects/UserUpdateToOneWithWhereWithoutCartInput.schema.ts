...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserUpdateToOneWithWhereWithoutCartInputObjectSchema: z.ZodType<Prisma.UserUpdateToOneWithWhereWithoutCartInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpdateToOneWithWhereWithoutCartInput>
export const UserUpdateToOneWithWhereWithoutCartInputObjectZodSchema =
  makeSchema()
