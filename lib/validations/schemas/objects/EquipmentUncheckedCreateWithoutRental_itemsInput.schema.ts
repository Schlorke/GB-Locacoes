...
export const EquipmentUncheckedCreateWithoutRental_itemsInputObjectSchema: z.ZodType<
  Prisma.EquipmentUncheckedCreateWithoutRental_itemsInput,
  Prisma.EquipmentUncheckedCreateWithoutRental_itemsInput
> = z
  .object({
  ...
  .strict()
export const EquipmentUncheckedCreateWithoutRental_itemsInputObjectZodSchema = z
  .object({
    id: z.string().optional(),
    name: z.string(),
    description: z.string().optional().nullable(),
