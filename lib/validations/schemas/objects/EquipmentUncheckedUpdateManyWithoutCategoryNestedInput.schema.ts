...
export const EquipmentUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema: z.ZodType<
  Prisma.EquipmentUncheckedUpdateManyWithoutCategoryNestedInput,
  Prisma.EquipmentUncheckedUpdateManyWithoutCategoryNestedInput
> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => EquipmentCreateWithoutCategoryInputObjectSchema).array(),
        z.lazy(() => EquipmentUncheckedCreateWithoutCategoryInputObjectSchema),
        z
          .lazy(() => EquipmentUncheckedCreateWithoutCategoryInputObjectSchema)
          .array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => EquipmentCreateOrConnectWithoutCategoryInputObjectSchema),
        z
          .lazy(() => EquipmentCreateOrConnectWithoutCategoryInputObjectSchema)
          .array(),
      ])
      .optional(),
    upsert: z
      .union([
        z.lazy(
          () => EquipmentUpsertWithWhereUniqueWithoutCategoryInputObjectSchema
        ),
        z
          .lazy(
            () => EquipmentUpsertWithWhereUniqueWithoutCategoryInputObjectSchema
      ...
      .optional(),
    createMany: z
      .lazy(() => EquipmentCreateManyCategoryInputEnvelopeObjectSchema)
      .optional(),
    set: z
      .union([
        z.lazy(() => EquipmentWhereUniqueInputObjectSchema),
        z.lazy(() => EquipmentWhereUniqueInputObjectSchema).array(),
      ])
      .optional(),
    disconnect: z
      .union([
    ...
    update: z
      .union([
        z.lazy(
          () => EquipmentUpdateWithWhereUniqueWithoutCategoryInputObjectSchema
        ),
        z
          .lazy(
            () => EquipmentUpdateWithWhereUniqueWithoutCategoryInputObjectSchema
    ...
    updateMany: z
      .union([
        z.lazy(
          () => EquipmentUpdateManyWithWhereWithoutCategoryInputObjectSchema
        ),
        z
          .lazy(
            () => EquipmentUpdateManyWithWhereWithoutCategoryInputObjectSchema
  ...
  .strict()
export const EquipmentUncheckedUpdateManyWithoutCategoryNestedInputObjectZodSchema =
  z
    .object({
      create: z
        .union([
          ...
          z.lazy(() => EquipmentCreateWithoutCategoryInputObjectSchema).array(),
          z.lazy(
            () => EquipmentUncheckedCreateWithoutCategoryInputObjectSchema
          ),
          z
            .lazy(
              () => EquipmentUncheckedCreateWithoutCategoryInputObjectSchema
      ...
      connectOrCreate: z
        .union([
          z.lazy(
            () => EquipmentCreateOrConnectWithoutCategoryInputObjectSchema
          ),
          z
            .lazy(
              () => EquipmentCreateOrConnectWithoutCategoryInputObjectSchema
