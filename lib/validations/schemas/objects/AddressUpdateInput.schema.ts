...
const makeSchema = () =>
  z
    .object({
      ...
      user: z
        .lazy(
          () => UserUpdateOneRequiredWithoutAddressesNestedInputObjectSchema
        )
        .optional(),
    })
    .strict()
export const AddressUpdateInputObjectSchema: z.ZodType<Prisma.AddressUpdateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressUpdateInput>
