...
export const EquipmentUpdateWithoutRental_itemsInputObjectSchema: z.ZodType<
  Prisma.EquipmentUpdateWithoutRental_itemsInput,
  Prisma.EquipmentUpdateWithoutRental_itemsInput
> = z
  .object({
    name: z
  ...
  .strict()
export const EquipmentUpdateWithoutRental_itemsInputObjectZodSchema = z
  .object({
    name: z
      .union([
        z.string(),
