...
export const EquipmentUpsertWithoutRental_itemsInputObjectSchema: z.ZodType<
  Prisma.EquipmentUpsertWithoutRental_itemsInput,
  Prisma.EquipmentUpsertWithoutRental_itemsInput
> = z
  .object({
    update: z.union([
  ...
  .strict()
export const EquipmentUpsertWithoutRental_itemsInputObjectZodSchema = z
  .object({
    update: z.union([
      z.lazy(() => EquipmentUpdateWithoutRental_itemsInputObjectSchema),
      z.lazy(
