...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserUpsertWithoutAddressesInputObjectSchema: z.ZodType<Prisma.UserUpsertWithoutAddressesInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpsertWithoutAddressesInput>
