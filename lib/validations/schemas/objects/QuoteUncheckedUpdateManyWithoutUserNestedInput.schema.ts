...
export const QuoteUncheckedUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<
  Prisma.QuoteUncheckedUpdateManyWithoutUserNestedInput,
  Prisma.QuoteUncheckedUpdateManyWithoutUserNestedInput
> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => QuoteUncheckedCreateWithoutUserInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => QuoteCreateOrConnectWithoutUserInputObjectSchema),
        z.lazy(() => QuoteCreateOrConnectWithoutUserInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
  ...
  .strict()
export const QuoteUncheckedUpdateManyWithoutUserNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteCreateWithoutUserInputObjectSchema),
