...
const makeSchema = () =>
  z
    .object({
      ...
      cartId_equipmentId: z
        .lazy(() => CartItemCartIdEquipmentIdCompoundUniqueInputObjectSchema)
        .optional(),
    })
    .strict()
    .superRefine((obj, ctx) => {
      ...
      const groups: string[][] = [['cartId', 'equipmentId']] as string[][]
...
export const CartItemWhereUniqueInputObjectSchema: z.ZodType<Prisma.CartItemWhereUniqueInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemWhereUniqueInput>
