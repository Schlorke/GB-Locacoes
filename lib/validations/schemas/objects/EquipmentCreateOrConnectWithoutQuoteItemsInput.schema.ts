...
export const EquipmentCreateOrConnectWithoutQuoteItemsInputObjectSchema: z.ZodType<
  Prisma.EquipmentCreateOrConnectWithoutQuoteItemsInput,
  Prisma.EquipmentCreateOrConnectWithoutQuoteItemsInput
> = z
  .object({
    ...
    create: z.union([
      ...
      z.lazy(() => EquipmentUncheckedCreateWithoutQuoteItemsInputObjectSchema),
    ]),
  })
  .strict()
export const EquipmentCreateOrConnectWithoutQuoteItemsInputObjectZodSchema = z
  .object({
    where: z.lazy(() => EquipmentWhereUniqueInputObjectSchema),
    create: z.union([
      z.lazy(() => EquipmentCreateWithoutQuoteItemsInputObjectSchema),
