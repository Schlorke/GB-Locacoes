...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartUncheckedCreateNestedOneWithoutUserInputObjectSchema: z.ZodType<Prisma.CartUncheckedCreateNestedOneWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartUncheckedCreateNestedOneWithoutUserInput>
export const CartUncheckedCreateNestedOneWithoutUserInputObjectZodSchema =
  makeSchema()
