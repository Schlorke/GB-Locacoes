...
export const QuoteItemUpdateManyWithoutEquipmentNestedInputObjectSchema: z.ZodType<
  Prisma.QuoteItemUpdateManyWithoutEquipmentNestedInput,
  Prisma.QuoteItemUpdateManyWithoutEquipmentNestedInput
> = z
  .object({
    create: z
  ...
  .strict()
export const QuoteItemUpdateManyWithoutEquipmentNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteItemCreateWithoutEquipmentInputObjectSchema),
