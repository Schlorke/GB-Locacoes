...
const makeSchema = () =>
  z
    .object({
      create: z
        .union([
          z.lazy(() => CartItemCreateWithoutCartInputObjectSchema),
          z.lazy(() => CartItemCreateWithoutCartInputObjectSchema).array(),
          z.lazy(() => CartItemUncheckedCreateWithoutCartInputObjectSchema),
          z
            .lazy(() => CartItemUncheckedCreateWithoutCartInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => CartItemCreateOrConnectWithoutCartInputObjectSchema),
          z
            .lazy(() => CartItemCreateOrConnectWithoutCartInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => CartItemUpsertWithWhereUniqueWithoutCartInputObjectSchema
          ),
          z
            .lazy(
              () => CartItemUpsertWithWhereUniqueWithoutCartInputObjectSchema
        ...
        .optional(),
      createMany: z
        .lazy(() => CartItemCreateManyCartInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => CartItemUpdateWithWhereUniqueWithoutCartInputObjectSchema
          ),
          z
            .lazy(
              () => CartItemUpdateWithWhereUniqueWithoutCartInputObjectSchema
      ...
      updateMany: z
        .union([
          z.lazy(() => CartItemUpdateManyWithWhereWithoutCartInputObjectSchema),
          z
            .lazy(() => CartItemUpdateManyWithWhereWithoutCartInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict()
export const CartItemUncheckedUpdateManyWithoutCartNestedInputObjectSchema: z.ZodType<Prisma.CartItemUncheckedUpdateManyWithoutCartNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemUncheckedUpdateManyWithoutCartNestedInput>
export const CartItemUncheckedUpdateManyWithoutCartNestedInputObjectZodSchema =
  makeSchema()
