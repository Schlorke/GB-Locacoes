...
const makeSchema = () =>
  z
    ...
    .strict()
export const EquipmentCreateNestedOneWithoutCartItemsInputObjectSchema: z.ZodType<Prisma.EquipmentCreateNestedOneWithoutCartItemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EquipmentCreateNestedOneWithoutCartItemsInput>
export const EquipmentCreateNestedOneWithoutCartItemsInputObjectZodSchema =
  makeSchema()
