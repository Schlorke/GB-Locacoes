...
const makeSchema = () =>
  z
    .object({
      ...
      equipment: z.lazy(
        () => EquipmentCreateNestedOneWithoutCartItemsInputObjectSchema
      ),
    })
    .strict()
export const CartItemCreateWithoutCartInputObjectSchema: z.ZodType<Prisma.CartItemCreateWithoutCartInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemCreateWithoutCartInput>
