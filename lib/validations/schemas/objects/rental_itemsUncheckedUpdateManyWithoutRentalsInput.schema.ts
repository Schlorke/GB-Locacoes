...
export const rental_itemsUncheckedUpdateManyWithoutRentalsInputObjectSchema: z.ZodType<Prisma.rental_itemsUncheckedUpdateManyWithoutRentalsInput, Prisma.rental_itemsUncheckedUpdateManyWithoutRentalsInput> = z.object({
...
export const rental_itemsUncheckedUpdateManyWithoutRentalsInputObjectZodSchema = z.object({
  equipmentid: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  quantity: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  priceperday: z.union([z.number(), z.lazy(() => DecimalFieldUpdateOperationsInputObjectSchema)]).optional(),
  totaldays: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
