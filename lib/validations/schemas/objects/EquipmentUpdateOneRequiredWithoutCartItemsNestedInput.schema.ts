...
const makeSchema = () =>
  z
    .object({
      create: z
        .union([
          z.lazy(() => EquipmentCreateWithoutCartItemsInputObjectSchema),
          z.lazy(
            () => EquipmentUncheckedCreateWithoutCartItemsInputObjectSchema
          ),
        ])
        .optional(),
      connectOrCreate: z
        .lazy(() => EquipmentCreateOrConnectWithoutCartItemsInputObjectSchema)
        .optional(),
      upsert: z
        .lazy(() => EquipmentUpsertWithoutCartItemsInputObjectSchema)
        .optional(),
      connect: z.lazy(() => EquipmentWhereUniqueInputObjectSchema).optional(),
      update: z
        .union([
          z.lazy(
            () => EquipmentUpdateToOneWithWhereWithoutCartItemsInputObjectSchema
          ),
          z.lazy(() => EquipmentUpdateWithoutCartItemsInputObjectSchema),
          z.lazy(
            () => EquipmentUncheckedUpdateWithoutCartItemsInputObjectSchema
          ),
        ])
        .optional(),
    })
    .strict()
export const EquipmentUpdateOneRequiredWithoutCartItemsNestedInputObjectSchema: z.ZodType<Prisma.EquipmentUpdateOneRequiredWithoutCartItemsNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EquipmentUpdateOneRequiredWithoutCartItemsNestedInput>
export const EquipmentUpdateOneRequiredWithoutCartItemsNestedInputObjectZodSchema =
  makeSchema()
