...
export const UserCreateWithoutQuotesInputObjectSchema: z.ZodType<
  Prisma.UserCreateWithoutQuotesInput,
  Prisma.UserCreateWithoutQuotesInput
> = z
  .object({
  ...
  .strict()
export const UserCreateWithoutQuotesInputObjectZodSchema = z
  .object({
    id: z.string().optional(),
    name: z.string().optional().nullable(),
    email: z.string(),
