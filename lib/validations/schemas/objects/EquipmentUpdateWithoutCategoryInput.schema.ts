...
export const EquipmentUpdateWithoutCategoryInputObjectSchema: z.ZodType<
  Prisma.EquipmentUpdateWithoutCategoryInput,
  Prisma.EquipmentUpdateWithoutCategoryInput
> = z
  .object({
    name: z
  ...
  .strict()
export const EquipmentUpdateWithoutCategoryInputObjectZodSchema = z
  .object({
    name: z
      .union([
        z.string(),
