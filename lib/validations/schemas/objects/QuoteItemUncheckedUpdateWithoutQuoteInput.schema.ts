...
export const QuoteItemUncheckedUpdateWithoutQuoteInputObjectSchema: z.ZodType<Prisma.QuoteItemUncheckedUpdateWithoutQuoteInput, Prisma.QuoteItemUncheckedUpdateWithoutQuoteInput> = z.object({
...
export const QuoteItemUncheckedUpdateWithoutQuoteInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  equipmentId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  quantity: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  days: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
