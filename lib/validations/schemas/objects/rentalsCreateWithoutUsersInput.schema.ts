...
export const rentalsCreateWithoutUsersInputObjectSchema: z.ZodType<
  Prisma.rentalsCreateWithoutUsersInput,
  Prisma.rentalsCreateWithoutUsersInput
> = z
  .object({
    id: z.string(),
  ...
  .strict()
export const rentalsCreateWithoutUsersInputObjectZodSchema = z
  .object({
    id: z.string(),
    startdate: z.date(),
    enddate: z.date(),
