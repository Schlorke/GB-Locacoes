...
export const rentalsCreateNestedManyWithoutUsersInputObjectSchema: z.ZodType<
  Prisma.rentalsCreateNestedManyWithoutUsersInput,
  Prisma.rentalsCreateNestedManyWithoutUsersInput
> = z
  .object({
    create: z
  ...
  .strict()
export const rentalsCreateNestedManyWithoutUsersInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => rentalsCreateWithoutUsersInputObjectSchema),
