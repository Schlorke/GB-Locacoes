...
export const CategoryUncheckedUpdateWithoutEquipmentsInputObjectSchema: z.ZodType<Prisma.CategoryUncheckedUpdateWithoutEquipmentsInput, Prisma.CategoryUncheckedUpdateWithoutEquipmentsInput> = z.object({
...
export const CategoryUncheckedUpdateWithoutEquipmentsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  icon: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
