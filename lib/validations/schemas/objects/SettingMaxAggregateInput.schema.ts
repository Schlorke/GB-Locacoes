...
const makeSchema = () =>
  z
    ...
    .strict()
export const SettingMaxAggregateInputObjectSchema: z.ZodType<Prisma.SettingMaxAggregateInputType> =
  makeSchema() as unknown as z.ZodType<Prisma.SettingMaxAggregateInputType>
