...
export const QuoteCreateNestedOneWithoutItemsInputObjectSchema: z.ZodType<
  Prisma.QuoteCreateNestedOneWithoutItemsInput,
  Prisma.QuoteCreateNestedOneWithoutItemsInput
> = z
  .object({
    create: z
  ...
  .strict()
export const QuoteCreateNestedOneWithoutItemsInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteCreateWithoutItemsInputObjectSchema),
