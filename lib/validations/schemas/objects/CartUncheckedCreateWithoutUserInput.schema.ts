...
const makeSchema = () =>
  z
    .object({
      ...
      items: z
        .lazy(
          () => CartItemUncheckedCreateNestedManyWithoutCartInputObjectSchema
        )
        .optional(),
    })
    .strict()
export const CartUncheckedCreateWithoutUserInputObjectSchema: z.ZodType<Prisma.CartUncheckedCreateWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartUncheckedCreateWithoutUserInput>
