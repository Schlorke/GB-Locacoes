  ...
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(() => EquipmentUncheckedUpdateWithoutCartItemsInputObjectSchema),
      ]),
    })
    .strict()
export const EquipmentUpdateToOneWithWhereWithoutCartItemsInputObjectSchema: z.ZodType<Prisma.EquipmentUpdateToOneWithWhereWithoutCartItemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EquipmentUpdateToOneWithWhereWithoutCartItemsInput>
export const EquipmentUpdateToOneWithWhereWithoutCartItemsInputObjectZodSchema =
  makeSchema()
