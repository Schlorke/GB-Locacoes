...
export const rental_itemsCreateManyEquipmentsInputEnvelopeObjectSchema: z.ZodType<
  Prisma.rental_itemsCreateManyEquipmentsInputEnvelope,
  Prisma.rental_itemsCreateManyEquipmentsInputEnvelope
> = z
  .object({
    data: z.union([
  ...
  .strict()
export const rental_itemsCreateManyEquipmentsInputEnvelopeObjectZodSchema = z
  .object({
    data: z.union([
      z.lazy(() => rental_itemsCreateManyEquipmentsInputObjectSchema),
      z.lazy(() => rental_itemsCreateManyEquipmentsInputObjectSchema).array(),
