...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartScalarRelationFilterObjectSchema: z.ZodType<Prisma.CartScalarRelationFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.CartScalarRelationFilter>
