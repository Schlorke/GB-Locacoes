...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserCreateOrConnectWithoutRentalsInputObjectSchema: z.ZodType<Prisma.UserCreateOrConnectWithoutRentalsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserCreateOrConnectWithoutRentalsInput>
export const UserCreateOrConnectWithoutRentalsInputObjectZodSchema =
  makeSchema()
