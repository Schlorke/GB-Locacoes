...
export const SettingCreateInputObjectSchema: z.ZodType<Prisma.SettingCreateInput, Prisma.SettingCreateInput> = z.object({
...
export const SettingCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  companyPhone: z.string().optional(),
  companyIconUrl: z.string().optional(),
  aboutUsText: z.string().optional(),
