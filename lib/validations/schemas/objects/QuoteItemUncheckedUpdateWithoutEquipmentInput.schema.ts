...
export const QuoteItemUncheckedUpdateWithoutEquipmentInputObjectSchema: z.ZodType<Prisma.QuoteItemUncheckedUpdateWithoutEquipmentInput, Prisma.QuoteItemUncheckedUpdateWithoutEquipmentInput> = z.object({
...
export const QuoteItemUncheckedUpdateWithoutEquipmentInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  quoteId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  quantity: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  days: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
