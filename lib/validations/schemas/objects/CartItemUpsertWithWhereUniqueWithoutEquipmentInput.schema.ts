...
const makeSchema = () =>
  z
    .object({
      ...
      update: z.union([
        z.lazy(() => CartItemUpdateWithoutEquipmentInputObjectSchema),
        z.lazy(() => CartItemUncheckedUpdateWithoutEquipmentInputObjectSchema),
      ]),
      create: z.union([
    ...
    .strict()
export const CartItemUpsertWithWhereUniqueWithoutEquipmentInputObjectSchema: z.ZodType<Prisma.CartItemUpsertWithWhereUniqueWithoutEquipmentInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemUpsertWithWhereUniqueWithoutEquipmentInput>
export const CartItemUpsertWithWhereUniqueWithoutEquipmentInputObjectZodSchema =
  makeSchema()
