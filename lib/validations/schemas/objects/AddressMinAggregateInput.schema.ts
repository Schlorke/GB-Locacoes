...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressMinAggregateInputObjectSchema: z.ZodType<Prisma.AddressMinAggregateInputType> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressMinAggregateInputType>
