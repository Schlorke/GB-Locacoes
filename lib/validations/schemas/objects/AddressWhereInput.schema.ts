...
const addresswhereinputSchema = z
  .object({
    AND: z
      .union([
  ...
  .strict()
export const AddressWhereInputObjectSchema: z.ZodType<Prisma.AddressWhereInput> =
  addresswhereinputSchema as unknown as z.ZodType<Prisma.AddressWhereInput>
