...
export const QuoteItemUpdateWithWhereUniqueWithoutQuoteInputObjectSchema: z.ZodType<
  Prisma.QuoteItemUpdateWithWhereUniqueWithoutQuoteInput,
  Prisma.QuoteItemUpdateWithWhereUniqueWithoutQuoteInput
> = z
  .object({
  ...
  .strict()
export const QuoteItemUpdateWithWhereUniqueWithoutQuoteInputObjectZodSchema = z
  .object({
    where: z.lazy(() => QuoteItemWhereUniqueInputObjectSchema),
    data: z.union([
      z.lazy(() => QuoteItemUpdateWithoutQuoteInputObjectSchema),
