...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartUpsertWithoutUserInputObjectSchema: z.ZodType<Prisma.CartUpsertWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartUpsertWithoutUserInput>
