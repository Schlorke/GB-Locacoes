...
export const EquipmentCreateOrConnectWithoutRental_itemsInputObjectSchema: z.ZodType<
  Prisma.EquipmentCreateOrConnectWithoutRental_itemsInput,
  Prisma.EquipmentCreateOrConnectWithoutRental_itemsInput
> = z
  .object({
  ...
  .strict()
export const EquipmentCreateOrConnectWithoutRental_itemsInputObjectZodSchema = z
  .object({
    where: z.lazy(() => EquipmentWhereUniqueInputObjectSchema),
    create: z.union([
      z.lazy(() => EquipmentCreateWithoutRental_itemsInputObjectSchema),
