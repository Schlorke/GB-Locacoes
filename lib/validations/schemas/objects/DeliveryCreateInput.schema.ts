...
import { rentalsCreateNestedOneWithoutDeliveriesInputObjectSchema as rentalsCreateNestedOneWithoutDeliveriesInputObjectSchema } from './rentalsCreateNestedOneWithoutDeliveriesInput.schema'
...
const makeSchema = () => z.object({
  ...
  rental: z.lazy(() => rentalsCreateNestedOneWithoutDeliveriesInputObjectSchema)
}).strict();
export const DeliveryCreateInputObjectSchema: z.ZodType<Prisma.DeliveryCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.DeliveryCreateInput>;
export const DeliveryCreateInputObjectZodSchema = makeSchema();
