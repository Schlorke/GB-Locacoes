...
export const rental_itemsUpdateManyWithoutRentalsNestedInputObjectSchema: z.ZodType<
  Prisma.rental_itemsUpdateManyWithoutRentalsNestedInput,
  Prisma.rental_itemsUpdateManyWithoutRentalsNestedInput
> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => rental_itemsCreateWithoutRentalsInputObjectSchema).array(),
        z.lazy(
  ...
  .strict()
export const rental_itemsUpdateManyWithoutRentalsNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => rental_itemsCreateWithoutRentalsInputObjectSchema),
