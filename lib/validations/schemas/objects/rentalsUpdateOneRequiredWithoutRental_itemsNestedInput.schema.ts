...
import { rentalsUpsertWithoutRental_itemsInputObjectSchema } from './rentalsUpsertWithoutRental_itemsInput.schema'
import { rentalsWhereUniqueInputObjectSchema } from './rentalsWhereUniqueInput.schema'
import { rentalsUpdateToOneWithWhereWithoutRental_itemsInputObjectSchema } from './rentalsUpdateToOneWithWhereWithoutRental_itemsInput.schema'
...
const makeSchema = (): z.ZodObject<any> =>
  z
    .object({
      create: z
        .union([
          ...
          z.lazy(
            () => rentalsUncheckedCreateWithoutRental_itemsInputObjectSchema
          ),
        ])
        .optional(),
      connectOrCreate: z
        .lazy(() => rentalsCreateOrConnectWithoutRental_itemsInputObjectSchema)
        .optional(),
      upsert: z
        .lazy(() => rentalsUpsertWithoutRental_itemsInputObjectSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(
            () =>
              rentalsUpdateToOneWithWhereWithoutRental_itemsInputObjectSchema
          ),
    ...
    .strict()
export const rentalsUpdateOneRequiredWithoutRental_itemsNestedInputObjectSchema: z.ZodType<Prisma.rentalsUpdateOneRequiredWithoutRental_itemsNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.rentalsUpdateOneRequiredWithoutRental_itemsNestedInput>
export const rentalsUpdateOneRequiredWithoutRental_itemsNestedInputObjectZodSchema =
  makeSchema()
