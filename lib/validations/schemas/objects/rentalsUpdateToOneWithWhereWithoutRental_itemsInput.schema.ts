...
export const rentalsUpdateToOneWithWhereWithoutRental_itemsInputObjectSchema: z.ZodType<Prisma.rentalsUpdateToOneWithWhereWithoutRental_itemsInput, Prisma.rentalsUpdateToOneWithWhereWithoutRental_itemsInput> = z.object({
...
export const rentalsUpdateToOneWithWhereWithoutRental_itemsInputObjectZodSchema = z.object({
  where: z.lazy(() => rentalsWhereInputObjectSchema).optional(),
  data: z.union([z.lazy(() => rentalsUpdateWithoutRental_itemsInputObjectSchema), z.lazy(() => rentalsUncheckedUpdateWithoutRental_itemsInputObjectSchema)])
}).strict();
