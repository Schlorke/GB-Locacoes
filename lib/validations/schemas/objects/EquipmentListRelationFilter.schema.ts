...
export const EquipmentListRelationFilterObjectSchema: z.ZodType<
  Prisma.EquipmentListRelationFilter,
  Prisma.EquipmentListRelationFilter
> = z
  .object({
  ...
  .strict()
export const EquipmentListRelationFilterObjectZodSchema = z
  .object({
    every: z.lazy(() => EquipmentWhereInputObjectSchema).optional(),
    some: z.lazy(() => EquipmentWhereInputObjectSchema).optional(),
    none: z.lazy(() => EquipmentWhereInputObjectSchema).optional(),
