...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserCreateOrConnectWithoutCartInputObjectSchema: z.ZodType<Prisma.UserCreateOrConnectWithoutCartInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserCreateOrConnectWithoutCartInput>
