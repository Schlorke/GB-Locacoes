...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressCountOrderByAggregateInputObjectSchema: z.ZodType<Prisma.AddressCountOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressCountOrderByAggregateInput>
