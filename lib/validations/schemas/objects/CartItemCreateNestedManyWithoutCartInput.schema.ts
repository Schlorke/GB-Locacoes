...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartItemCreateNestedManyWithoutCartInputObjectSchema: z.ZodType<Prisma.CartItemCreateNestedManyWithoutCartInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemCreateNestedManyWithoutCartInput>
export const CartItemCreateNestedManyWithoutCartInputObjectZodSchema =
  makeSchema()
