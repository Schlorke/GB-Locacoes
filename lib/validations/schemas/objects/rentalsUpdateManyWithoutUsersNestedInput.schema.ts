...
export const rentalsUpdateManyWithoutUsersNestedInputObjectSchema: z.ZodType<
  Prisma.rentalsUpdateManyWithoutUsersNestedInput,
  Prisma.rentalsUpdateManyWithoutUsersNestedInput
> = z
  .object({
    create: z
  ...
  .strict()
export const rentalsUpdateManyWithoutUsersNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => rentalsCreateWithoutUsersInputObjectSchema),
