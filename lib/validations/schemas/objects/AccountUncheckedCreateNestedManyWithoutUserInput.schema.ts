...
export const AccountUncheckedCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<
...
> = z
  ...
  .strict()
export const AccountUncheckedCreateNestedManyWithoutUserInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => AccountCreateWithoutUserInputObjectSchema),
