...
export const QuoteUpdateToOneWithWhereWithoutItemsInputObjectSchema: z.ZodType<Prisma.QuoteUpdateToOneWithWhereWithoutItemsInput, Prisma.QuoteUpdateToOneWithWhereWithoutItemsInput> = z.object({
...
export const QuoteUpdateToOneWithWhereWithoutItemsInputObjectZodSchema = z.object({
  where: z.lazy(() => QuoteWhereInputObjectSchema).optional(),
  data: z.union([z.lazy(() => QuoteUpdateWithoutItemsInputObjectSchema), z.lazy(() => QuoteUncheckedUpdateWithoutItemsInputObjectSchema)])
}).strict();
