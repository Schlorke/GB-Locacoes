...
export const NestedEnumRoleWithAggregatesFilterObjectSchema: z.ZodType<
  Prisma.NestedEnumRoleWithAggregatesFilter,
  Prisma.NestedEnumRoleWithAggregatesFilter
> = z
  .object({
  ...
  .strict()
export const NestedEnumRoleWithAggregatesFilterObjectZodSchema = z
  .object({
    equals: RoleSchema.optional(),
    in: RoleSchema.array().optional(),
    notIn: RoleSchema.array().optional(),
