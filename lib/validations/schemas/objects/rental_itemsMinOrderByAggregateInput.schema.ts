...
const makeSchema = () =>
  z
    ...
    .strict()
export const rental_itemsMinOrderByAggregateInputObjectSchema: z.ZodType<Prisma.rental_itemsMinOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.rental_itemsMinOrderByAggregateInput>
