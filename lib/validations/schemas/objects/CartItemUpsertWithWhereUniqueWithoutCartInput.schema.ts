...
const makeSchema = () =>
  z
    .object({
      ...
      update: z.union([
        z.lazy(() => CartItemUpdateWithoutCartInputObjectSchema),
        z.lazy(() => CartItemUncheckedUpdateWithoutCartInputObjectSchema),
      ]),
      create: z.union([
    ...
    .strict()
export const CartItemUpsertWithWhereUniqueWithoutCartInputObjectSchema: z.ZodType<Prisma.CartItemUpsertWithWhereUniqueWithoutCartInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemUpsertWithWhereUniqueWithoutCartInput>
export const CartItemUpsertWithWhereUniqueWithoutCartInputObjectZodSchema =
  makeSchema()
