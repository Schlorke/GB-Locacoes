...
export const QuoteItemCreateManyQuoteInputEnvelopeObjectSchema: z.ZodType<
  Prisma.QuoteItemCreateManyQuoteInputEnvelope,
  Prisma.QuoteItemCreateManyQuoteInputEnvelope
> = z
  .object({
    data: z.union([
  ...
  .strict()
export const QuoteItemCreateManyQuoteInputEnvelopeObjectZodSchema = z
  .object({
    data: z.union([
      z.lazy(() => QuoteItemCreateManyQuoteInputObjectSchema),
      z.lazy(() => QuoteItemCreateManyQuoteInputObjectSchema).array(),
