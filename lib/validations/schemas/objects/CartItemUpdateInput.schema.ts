  ...
  z
    .object({
      ...
      createdAt: z
        ...
        .optional(),
      cart: z
        .lazy(() => CartUpdateOneRequiredWithoutItemsNestedInputObjectSchema)
        .optional(),
      equipment: z
        .lazy(
          () =>
            EquipmentUpdateOneRequiredWithoutCartItemsNestedInputObjectSchema
        )
        .optional(),
    })
    .strict()
export const CartItemUpdateInputObjectSchema: z.ZodType<Prisma.CartItemUpdateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemUpdateInput>
