...
export const rentalsUncheckedUpdateInputObjectSchema: z.ZodType<
  Prisma.rentalsUncheckedUpdateInput,
  Prisma.rentalsUncheckedUpdateInput
> = z
  .object({
    startdate: z
  ...
  .strict()
export const rentalsUncheckedUpdateInputObjectZodSchema = z
  .object({
    startdate: z
      .union([
        z.date(),
