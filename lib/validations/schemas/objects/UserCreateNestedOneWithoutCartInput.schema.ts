...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserCreateNestedOneWithoutCartInputObjectSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutCartInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserCreateNestedOneWithoutCartInput>
