...
export const UserUpdateOneRequiredWithoutRentalsNestedInputObjectSchema: z.ZodType<
  Prisma.UserUpdateOneRequiredWithoutRentalsNestedInput,
  Prisma.UserUpdateOneRequiredWithoutRentalsNestedInput
> = z
  .object({
    create: z
  ...
  .strict()
export const UserUpdateOneRequiredWithoutRentalsNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => UserCreateWithoutRentalsInputObjectSchema),
