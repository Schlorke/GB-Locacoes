  ...
  z
    .object({
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutRentalsInputObjectSchema)
        .optional(),
      connect: z.lazy(() => UserWhereUniqueInputObjectSchema).optional(),
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutRentalsInputObjectSchema),
    ...
    .strict()
export const UserUpdateOneRequiredWithoutRentalsNestedInputObjectSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutRentalsNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpdateOneRequiredWithoutRentalsNestedInput>
export const UserUpdateOneRequiredWithoutRentalsNestedInputObjectZodSchema =
  makeSchema()
