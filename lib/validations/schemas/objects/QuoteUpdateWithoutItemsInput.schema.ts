...
export const QuoteUpdateWithoutItemsInputObjectSchema: z.ZodType<
  Prisma.QuoteUpdateWithoutItemsInput,
  Prisma.QuoteUpdateWithoutItemsInput
> = z
  .object({
    name: z
  ...
  .strict()
export const QuoteUpdateWithoutItemsInputObjectZodSchema = z
  .object({
    name: z
      .union([
        z.string(),
