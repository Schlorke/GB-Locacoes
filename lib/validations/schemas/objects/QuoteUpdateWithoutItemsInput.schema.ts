  ...
  z
    .object({
      ...
      updatedAt: z
        ...
        .optional(),
      user: z
        .lazy(() => UserUpdateOneWithoutQuotesNestedInputObjectSchema)
        .optional(),
    })
    .strict()
export const QuoteUpdateWithoutItemsInputObjectSchema: z.ZodType<Prisma.QuoteUpdateWithoutItemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.QuoteUpdateWithoutItemsInput>
