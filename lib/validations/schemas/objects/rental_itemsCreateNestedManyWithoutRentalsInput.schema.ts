...
export const rental_itemsCreateNestedManyWithoutRentalsInputObjectSchema: z.ZodType<
  Prisma.rental_itemsCreateNestedManyWithoutRentalsInput,
  Prisma.rental_itemsCreateNestedManyWithoutRentalsInput
> = z
  .object({
    create: z
  ...
  .strict()
export const rental_itemsCreateNestedManyWithoutRentalsInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => rental_itemsCreateWithoutRentalsInputObjectSchema),
