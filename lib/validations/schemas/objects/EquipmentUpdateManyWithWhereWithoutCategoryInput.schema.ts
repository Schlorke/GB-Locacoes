...
export const EquipmentUpdateManyWithWhereWithoutCategoryInputObjectSchema: z.ZodType<
  Prisma.EquipmentUpdateManyWithWhereWithoutCategoryInput,
  Prisma.EquipmentUpdateManyWithWhereWithoutCategoryInput
> = z
  .object({
  ...
  .strict()
export const EquipmentUpdateManyWithWhereWithoutCategoryInputObjectZodSchema = z
  .object({
    where: z.lazy(() => EquipmentScalarWhereInputObjectSchema),
    data: z.union([
      z.lazy(() => EquipmentUpdateManyMutationInputObjectSchema),
