...
export const QuoteUpdateWithWhereUniqueWithoutUserInputObjectSchema: z.ZodType<
  Prisma.QuoteUpdateWithWhereUniqueWithoutUserInput,
  Prisma.QuoteUpdateWithWhereUniqueWithoutUserInput
> = z
  .object({
  ...
  .strict()
export const QuoteUpdateWithWhereUniqueWithoutUserInputObjectZodSchema = z
  .object({
    where: z.lazy(() => QuoteWhereUniqueInputObjectSchema),
    data: z.union([
      z.lazy(() => QuoteUpdateWithoutUserInputObjectSchema),
