...
export const rental_itemsCreateManyRentalsInputEnvelopeObjectSchema: z.ZodType<
  Prisma.rental_itemsCreateManyRentalsInputEnvelope,
  Prisma.rental_itemsCreateManyRentalsInputEnvelope
> = z
  .object({
    data: z.union([
  ...
  .strict()
export const rental_itemsCreateManyRentalsInputEnvelopeObjectZodSchema = z
  .object({
    data: z.union([
      z.lazy(() => rental_itemsCreateManyRentalsInputObjectSchema),
      z.lazy(() => rental_itemsCreateManyRentalsInputObjectSchema).array(),
