...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressListRelationFilterObjectSchema: z.ZodType<Prisma.AddressListRelationFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressListRelationFilter>
