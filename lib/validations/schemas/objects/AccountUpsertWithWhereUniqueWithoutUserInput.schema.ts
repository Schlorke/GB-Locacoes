...
export const AccountUpsertWithWhereUniqueWithoutUserInputObjectSchema: z.ZodType<
...
> = z
  ...
  .strict()
export const AccountUpsertWithWhereUniqueWithoutUserInputObjectZodSchema = z
  .object({
    where: z.lazy(() => AccountWhereUniqueInputObjectSchema),
    update: z.union([
      z.lazy(() => AccountUpdateWithoutUserInputObjectSchema),
