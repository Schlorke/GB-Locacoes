...
export const QuoteUpdateManyWithWhereWithoutUserInputObjectSchema: z.ZodType<
  Prisma.QuoteUpdateManyWithWhereWithoutUserInput,
  Prisma.QuoteUpdateManyWithWhereWithoutUserInput
> = z
  .object({
  ...
  .strict()
export const QuoteUpdateManyWithWhereWithoutUserInputObjectZodSchema = z
  .object({
    where: z.lazy(() => QuoteScalarWhereInputObjectSchema),
    data: z.union([
      z.lazy(() => QuoteUpdateManyMutationInputObjectSchema),
