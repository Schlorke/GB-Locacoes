...
export const rental_itemsUncheckedUpdateWithoutRentalsInputObjectSchema: z.ZodType<Prisma.rental_itemsUncheckedUpdateWithoutRentalsInput, Prisma.rental_itemsUncheckedUpdateWithoutRentalsInput> = z.object({
...
export const rental_itemsUncheckedUpdateWithoutRentalsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  equipmentid: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  quantity: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  priceperday: z.union([z.number(), z.lazy(() => DecimalFieldUpdateOperationsInputObjectSchema)]).optional(),
