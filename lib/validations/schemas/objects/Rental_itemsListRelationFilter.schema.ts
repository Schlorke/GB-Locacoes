...
export const Rental_itemsListRelationFilterObjectSchema: z.ZodType<
  Prisma.Rental_itemsListRelationFilter,
  Prisma.Rental_itemsListRelationFilter
> = z
  .object({
  ...
  .strict()
export const Rental_itemsListRelationFilterObjectZodSchema = z
  .object({
    every: z.lazy(() => rental_itemsWhereInputObjectSchema).optional(),
    some: z.lazy(() => rental_itemsWhereInputObjectSchema).optional(),
    none: z.lazy(() => rental_itemsWhereInputObjectSchema).optional(),
