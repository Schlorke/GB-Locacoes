...
export const UserCreateNestedOneWithoutRentalsInputObjectSchema: z.ZodType<
  Prisma.UserCreateNestedOneWithoutRentalsInput,
  Prisma.UserCreateNestedOneWithoutRentalsInput
> = z
  .object({
    create: z
  ...
  .strict()
export const UserCreateNestedOneWithoutRentalsInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => UserCreateWithoutRentalsInputObjectSchema),
