...
export const EnumQuoteStatusWithAggregatesFilterObjectSchema: z.ZodType<
  Prisma.EnumQuoteStatusWithAggregatesFilter,
  Prisma.EnumQuoteStatusWithAggregatesFilter
> = z
  .object({
  ...
  .strict()
export const EnumQuoteStatusWithAggregatesFilterObjectZodSchema = z
  .object({
    equals: QuoteStatusSchema.optional(),
    in: QuoteStatusSchema.array().optional(),
    notIn: QuoteStatusSchema.array().optional(),
