...
export const EquipmentUpsertWithoutQuoteItemsInputObjectSchema: z.ZodType<
  Prisma.EquipmentUpsertWithoutQuoteItemsInput,
  Prisma.EquipmentUpsertWithoutQuoteItemsInput
> = z
  .object({
    update: z.union([
  ...
  .strict()
export const EquipmentUpsertWithoutQuoteItemsInputObjectZodSchema = z
  .object({
    update: z.union([
      z.lazy(() => EquipmentUpdateWithoutQuoteItemsInputObjectSchema),
      z.lazy(() => EquipmentUncheckedUpdateWithoutQuoteItemsInputObjectSchema),
