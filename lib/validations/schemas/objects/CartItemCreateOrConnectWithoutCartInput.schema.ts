...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartItemCreateOrConnectWithoutCartInputObjectSchema: z.ZodType<Prisma.CartItemCreateOrConnectWithoutCartInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemCreateOrConnectWithoutCartInput>
export const CartItemCreateOrConnectWithoutCartInputObjectZodSchema =
  makeSchema()
