...
export const NestedEnumQuoteStatusWithAggregatesFilterObjectSchema: z.ZodType<Prisma.NestedEnumQuoteStatusWithAggregatesFilter, Prisma.NestedEnumQuoteStatusWithAggregatesFilter> = z.object({
...
export const NestedEnumQuoteStatusWithAggregatesFilterObjectZodSchema = z.object({
  equals: QuoteStatusSchema.optional(),
  in: QuoteStatusSchema.array().optional(),
  notIn: QuoteStatusSchema.array().optional(),
  not: z.union([QuoteStatusSchema, z.lazy(() => NestedEnumQuoteStatusWithAggregatesFilterObjectSchema)]).optional(),
