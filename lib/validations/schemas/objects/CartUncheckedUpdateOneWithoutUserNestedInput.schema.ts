...
const makeSchema = () =>
  z
    .object({
      ...
      disconnect: z
        .union([z.boolean(), z.lazy(() => CartWhereInputObjectSchema)])
        .optional(),
      delete: z
        .union([z.boolean(), z.lazy(() => CartWhereInputObjectSchema)])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => CartUpdateToOneWithWhereWithoutUserInputObjectSchema),
    ...
    .strict()
export const CartUncheckedUpdateOneWithoutUserNestedInputObjectSchema: z.ZodType<Prisma.CartUncheckedUpdateOneWithoutUserNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartUncheckedUpdateOneWithoutUserNestedInput>
export const CartUncheckedUpdateOneWithoutUserNestedInputObjectZodSchema =
  makeSchema()
