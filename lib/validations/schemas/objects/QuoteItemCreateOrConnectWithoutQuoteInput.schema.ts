...
export const QuoteItemCreateOrConnectWithoutQuoteInputObjectSchema: z.ZodType<
  Prisma.QuoteItemCreateOrConnectWithoutQuoteInput,
  Prisma.QuoteItemCreateOrConnectWithoutQuoteInput
> = z
  .object({
  ...
  .strict()
export const QuoteItemCreateOrConnectWithoutQuoteInputObjectZodSchema = z
  .object({
    where: z.lazy(() => QuoteItemWhereUniqueInputObjectSchema),
    create: z.union([
      z.lazy(() => QuoteItemCreateWithoutQuoteInputObjectSchema),
