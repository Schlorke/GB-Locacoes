...
export const EquipmentCreateNestedManyWithoutCategoryInputObjectSchema: z.ZodType<
  Prisma.EquipmentCreateNestedManyWithoutCategoryInput,
  Prisma.EquipmentCreateNestedManyWithoutCategoryInput
> = z
  .object({
    create: z
  ...
  .strict()
export const EquipmentCreateNestedManyWithoutCategoryInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => EquipmentCreateWithoutCategoryInputObjectSchema),
