...
export const AccountUncheckedUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<
...
> = z
  ...
  .strict()
export const AccountUncheckedUpdateManyWithoutUserNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => AccountCreateWithoutUserInputObjectSchema),
