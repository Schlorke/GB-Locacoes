...
const makeSchema = () =>
  z
    .object({
      create: z
        .union([
          z.lazy(() => CartCreateWithoutItemsInputObjectSchema),
          z.lazy(() => CartUncheckedCreateWithoutItemsInputObjectSchema),
        ])
        .optional(),
      connectOrCreate: z
        .lazy(() => CartCreateOrConnectWithoutItemsInputObjectSchema)
        .optional(),
      upsert: z.lazy(() => CartUpsertWithoutItemsInputObjectSchema).optional(),
      connect: z.lazy(() => CartWhereUniqueInputObjectSchema).optional(),
      update: z
        .union([
          z.lazy(() => CartUpdateToOneWithWhereWithoutItemsInputObjectSchema),
          z.lazy(() => CartUpdateWithoutItemsInputObjectSchema),
          z.lazy(() => CartUncheckedUpdateWithoutItemsInputObjectSchema),
        ])
        .optional(),
    })
    .strict()
export const CartUpdateOneRequiredWithoutItemsNestedInputObjectSchema: z.ZodType<Prisma.CartUpdateOneRequiredWithoutItemsNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartUpdateOneRequiredWithoutItemsNestedInput>
export const CartUpdateOneRequiredWithoutItemsNestedInputObjectZodSchema =
  makeSchema()
