...
export const QuoteScalarWhereInputObjectSchema: z.ZodType<
  Prisma.QuoteScalarWhereInput,
  Prisma.QuoteScalarWhereInput
> = z
  .object({
    AND: z
      ...
      .optional(),
    OR: z
      .lazy(() => QuoteScalarWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
  ...
  .strict()
export const QuoteScalarWhereInputObjectZodSchema = z
  .object({
    AND: z
      .union([
        z.lazy(() => QuoteScalarWhereInputObjectSchema),
