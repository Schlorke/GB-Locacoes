...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartNullableScalarRelationFilterObjectSchema: z.ZodType<Prisma.CartNullableScalarRelationFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.CartNullableScalarRelationFilter>
