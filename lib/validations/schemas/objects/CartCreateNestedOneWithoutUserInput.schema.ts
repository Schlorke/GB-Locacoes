...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartCreateNestedOneWithoutUserInputObjectSchema: z.ZodType<Prisma.CartCreateNestedOneWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartCreateNestedOneWithoutUserInput>
