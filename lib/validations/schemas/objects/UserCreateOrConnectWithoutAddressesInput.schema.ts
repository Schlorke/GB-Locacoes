...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserCreateOrConnectWithoutAddressesInputObjectSchema: z.ZodType<Prisma.UserCreateOrConnectWithoutAddressesInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserCreateOrConnectWithoutAddressesInput>
export const UserCreateOrConnectWithoutAddressesInputObjectZodSchema =
  makeSchema()
