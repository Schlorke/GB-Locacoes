...
export const Rental_itemsMaxAggregateInputObjectSchema: z.ZodType<
  Prisma.Rental_itemsMaxAggregateInputType,
  Prisma.Rental_itemsMaxAggregateInputType
> = z
  .object({
  ...
  .strict()
export const Rental_itemsMaxAggregateInputObjectZodSchema = z
  .object({
    id: z.literal(true).optional(),
    rentalid: z.literal(true).optional(),
    equipmentid: z.literal(true).optional(),
