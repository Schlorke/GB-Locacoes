...
const makeSchema = () =>
  z
    ...
    .strict()
export const Rental_itemsMaxAggregateInputObjectSchema: z.ZodType<Prisma.Rental_itemsMaxAggregateInputType> =
  makeSchema() as unknown as z.ZodType<Prisma.Rental_itemsMaxAggregateInputType>
