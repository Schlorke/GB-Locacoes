...
export const QuoteUncheckedCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<
  Prisma.QuoteUncheckedCreateNestedManyWithoutUserInput,
  Prisma.QuoteUncheckedCreateNestedManyWithoutUserInput
> = z
  .object({
    create: z
  ...
  .strict()
export const QuoteUncheckedCreateNestedManyWithoutUserInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteCreateWithoutUserInputObjectSchema),
