...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserUpsertWithoutCartInputObjectSchema: z.ZodType<Prisma.UserUpsertWithoutCartInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpsertWithoutCartInput>
