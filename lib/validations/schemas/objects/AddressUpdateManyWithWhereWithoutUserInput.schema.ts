  ...
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(() => AddressUncheckedUpdateManyWithoutUserInputObjectSchema),
      ]),
    })
    .strict()
export const AddressUpdateManyWithWhereWithoutUserInputObjectSchema: z.ZodType<Prisma.AddressUpdateManyWithWhereWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressUpdateManyWithWhereWithoutUserInput>
export const AddressUpdateManyWithWhereWithoutUserInputObjectZodSchema =
  makeSchema()
