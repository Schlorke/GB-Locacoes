...
const makeSchema = () =>
  z
    .object({
      create: z
        .union([
          ...
          z.lazy(() => CartItemCreateWithoutEquipmentInputObjectSchema).array(),
          z.lazy(
            () => CartItemUncheckedCreateWithoutEquipmentInputObjectSchema
          ),
          z
            .lazy(
              () => CartItemUncheckedCreateWithoutEquipmentInputObjectSchema
      ...
      connectOrCreate: z
        .union([
          z.lazy(
            () => CartItemCreateOrConnectWithoutEquipmentInputObjectSchema
          ),
          z
            .lazy(
              () => CartItemCreateOrConnectWithoutEquipmentInputObjectSchema
      ...
      upsert: z
        .union([
          z.lazy(
            () => CartItemUpsertWithWhereUniqueWithoutEquipmentInputObjectSchema
          ),
          z
            .lazy(
              () =>
        ...
        .optional(),
      createMany: z
        .lazy(() => CartItemCreateManyEquipmentInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => CartItemUpdateWithWhereUniqueWithoutEquipmentInputObjectSchema
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () => CartItemUpdateManyWithWhereWithoutEquipmentInputObjectSchema
          ),
          z
            .lazy(
              () => CartItemUpdateManyWithWhereWithoutEquipmentInputObjectSchema
    ...
    .strict()
export const CartItemUncheckedUpdateManyWithoutEquipmentNestedInputObjectSchema: z.ZodType<Prisma.CartItemUncheckedUpdateManyWithoutEquipmentNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemUncheckedUpdateManyWithoutEquipmentNestedInput>
export const CartItemUncheckedUpdateManyWithoutEquipmentNestedInputObjectZodSchema =
  makeSchema()
