...
export const rentalsUncheckedUpdateManyWithoutUsersNestedInputObjectSchema: z.ZodType<
  Prisma.rentalsUncheckedUpdateManyWithoutUsersNestedInput,
  Prisma.rentalsUncheckedUpdateManyWithoutUsersNestedInput
> = z
  .object({
    create: z
    ...
    upsert: z
      .union([
        z.lazy(() => rentalsUpsertWithWhereUniqueWithoutUsersInputObjectSchema),
        z
          .lazy(() => rentalsUpsertWithWhereUniqueWithoutUsersInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => rentalsUpdateWithWhereUniqueWithoutUsersInputObjectSchema),
        z
          .lazy(() => rentalsUpdateWithWhereUniqueWithoutUsersInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
      .union([
        z.lazy(() => rentalsUpdateManyWithWhereWithoutUsersInputObjectSchema),
        z
          .lazy(() => rentalsUpdateManyWithWhereWithoutUsersInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
  ...
  .strict()
export const rentalsUncheckedUpdateManyWithoutUsersNestedInputObjectZodSchema =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => rentalsUpsertWithWhereUniqueWithoutUsersInputObjectSchema
          ),
          z
            .lazy(
              () => rentalsUpsertWithWhereUniqueWithoutUsersInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => rentalsUpdateWithWhereUniqueWithoutUsersInputObjectSchema
          ),
          z
            .lazy(
              () => rentalsUpdateWithWhereUniqueWithoutUsersInputObjectSchema
