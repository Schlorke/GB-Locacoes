...
export const UserUpdateToOneWithWhereWithoutQuotesInputObjectSchema: z.ZodType<
  Prisma.UserUpdateToOneWithWhereWithoutQuotesInput,
  Prisma.UserUpdateToOneWithWhereWithoutQuotesInput
> = z
  .object({
  ...
  .strict()
export const UserUpdateToOneWithWhereWithoutQuotesInputObjectZodSchema = z
  .object({
    where: z.lazy(() => UserWhereInputObjectSchema).optional(),
    data: z.union([
      z.lazy(() => UserUpdateWithoutQuotesInputObjectSchema),
