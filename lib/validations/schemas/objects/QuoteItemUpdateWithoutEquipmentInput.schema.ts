...
export const QuoteItemUpdateWithoutEquipmentInputObjectSchema: z.ZodType<
  Prisma.QuoteItemUpdateWithoutEquipmentInput,
  Prisma.QuoteItemUpdateWithoutEquipmentInput
> = z
  .object({
    quantity: z
  ...
  .strict()
export const QuoteItemUpdateWithoutEquipmentInputObjectZodSchema = z
  .object({
    quantity: z
      .union([
        z.number().int(),
