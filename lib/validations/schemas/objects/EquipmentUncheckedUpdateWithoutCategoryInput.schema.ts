...
export const EquipmentUncheckedUpdateWithoutCategoryInputObjectSchema: z.ZodType<
  Prisma.EquipmentUncheckedUpdateWithoutCategoryInput,
  Prisma.EquipmentUncheckedUpdateWithoutCategoryInput
> = z
  .object({
    id: z
  ...
  .strict()
export const EquipmentUncheckedUpdateWithoutCategoryInputObjectZodSchema = z
  .object({
    id: z
      .union([
        z.string(),
