...
export const CategoryCreateOrConnectWithoutEquipmentsInputObjectSchema: z.ZodType<
  Prisma.CategoryCreateOrConnectWithoutEquipmentsInput,
  Prisma.CategoryCreateOrConnectWithoutEquipmentsInput
> = z
  .object({
  ...
  .strict()
export const CategoryCreateOrConnectWithoutEquipmentsInputObjectZodSchema = z
  .object({
    where: z.lazy(() => CategoryWhereUniqueInputObjectSchema),
    create: z.union([
      z.lazy(() => CategoryCreateWithoutEquipmentsInputObjectSchema),
