...
export const EquipmentUpdateWithoutQuoteItemsInputObjectSchema: z.ZodType<
  Prisma.EquipmentUpdateWithoutQuoteItemsInput,
  Prisma.EquipmentUpdateWithoutQuoteItemsInput
> = z
  .object({
    name: z
  ...
  .strict()
export const EquipmentUpdateWithoutQuoteItemsInputObjectZodSchema = z
  .object({
    name: z
      .union([
        z.string(),
