...
export const EquipmentUpdateWithoutQuoteItemsInputObjectSchema: z.ZodType<Prisma.EquipmentUpdateWithoutQuoteItemsInput, Prisma.EquipmentUpdateWithoutQuoteItemsInput> = z.object({
...
export const EquipmentUpdateWithoutQuoteItemsInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  pricePerDay: z.union([z.number(), z.lazy(() => DecimalFieldUpdateOperationsInputObjectSchema)]).optional(),
  images: z.union([z.lazy(() => EquipmentUpdateimagesInputObjectSchema), z.string().array()]).optional(),
