...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartCreateWithoutItemsInputObjectSchema: z.ZodType<Prisma.CartCreateWithoutItemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartCreateWithoutItemsInput>
