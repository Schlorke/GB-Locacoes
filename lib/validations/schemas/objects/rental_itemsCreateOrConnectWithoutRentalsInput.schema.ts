...
export const rental_itemsCreateOrConnectWithoutRentalsInputObjectSchema: z.ZodType<
  Prisma.rental_itemsCreateOrConnectWithoutRentalsInput,
  Prisma.rental_itemsCreateOrConnectWithoutRentalsInput
> = z
  .object({
    ...
    create: z.union([
      ...
      z.lazy(() => rental_itemsUncheckedCreateWithoutRentalsInputObjectSchema),
    ]),
  })
  .strict()
export const rental_itemsCreateOrConnectWithoutRentalsInputObjectZodSchema = z
  .object({
    where: z.lazy(() => rental_itemsWhereUniqueInputObjectSchema),
    create: z.union([
      z.lazy(() => rental_itemsCreateWithoutRentalsInputObjectSchema),
