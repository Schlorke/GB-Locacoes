...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartUncheckedCreateInputObjectSchema: z.ZodType<Prisma.CartUncheckedCreateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartUncheckedCreateInput>
