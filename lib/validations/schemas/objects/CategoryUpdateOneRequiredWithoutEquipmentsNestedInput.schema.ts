...
export const CategoryUpdateOneRequiredWithoutEquipmentsNestedInputObjectSchema: z.ZodType<Prisma.CategoryUpdateOneRequiredWithoutEquipmentsNestedInput, Prisma.CategoryUpdateOneRequiredWithoutEquipmentsNestedInput> = z.object({
...
export const CategoryUpdateOneRequiredWithoutEquipmentsNestedInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => CategoryCreateWithoutEquipmentsInputObjectSchema), z.lazy(() => CategoryUncheckedCreateWithoutEquipmentsInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => CategoryCreateOrConnectWithoutEquipmentsInputObjectSchema).optional(),
  upsert: z.lazy(() => CategoryUpsertWithoutEquipmentsInputObjectSchema).optional(),
  connect: z.lazy(() => CategoryWhereUniqueInputObjectSchema).optional(),
