...
export const rentalsCreateInputObjectSchema: z.ZodType<Prisma.rentalsCreateInput, Prisma.rentalsCreateInput> = z.object({
  id: z.string(),
  startdate: z.date(),
  enddate: z.date(),
  total: z.number(),
...
export const rentalsCreateInputObjectZodSchema = z.object({
  id: z.string(),
  startdate: z.date(),
  enddate: z.date(),
  total: z.number(),
