...
export const EquipmentUncheckedCreateWithoutQuoteItemsInputObjectSchema: z.ZodType<Prisma.EquipmentUncheckedCreateWithoutQuoteItemsInput, Prisma.EquipmentUncheckedCreateWithoutQuoteItemsInput> = z.object({
...
export const EquipmentUncheckedCreateWithoutQuoteItemsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().nullish(),
  pricePerDay: z.number(),
