...
const makeSchema = (): z.ZodObject<any> =>
  z
    .object({
      ...
      connectOrCreate: z
        .lazy(
          () => EquipmentCreateOrConnectWithoutRental_itemsInputObjectSchema
        )
        .optional(),
      upsert: z
        .lazy(() => EquipmentUpsertWithoutRental_itemsInputObjectSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(
            () =>
              EquipmentUpdateToOneWithWhereWithoutRental_itemsInputObjectSchema
          ),
    ...
    .strict()
export const EquipmentUpdateOneRequiredWithoutRental_itemsNestedInputObjectSchema: z.ZodType<Prisma.EquipmentUpdateOneRequiredWithoutRental_itemsNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EquipmentUpdateOneRequiredWithoutRental_itemsNestedInput>
export const EquipmentUpdateOneRequiredWithoutRental_itemsNestedInputObjectZodSchema =
  makeSchema()
