...
export const DeliveryMaxAggregateInputObjectSchema: z.ZodType<Prisma.DeliveryMaxAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.DeliveryMaxAggregateInputType>;
export const DeliveryMaxAggregateInputObjectZodSchema = makeSchema();
