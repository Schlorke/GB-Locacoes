...
const makeSchema = () =>
  z
    ...
    .strict()
export const rentalsCreateNestedOneWithoutRental_itemsInputObjectSchema: z.ZodType<Prisma.rentalsCreateNestedOneWithoutRental_itemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.rentalsCreateNestedOneWithoutRental_itemsInput>
export const rentalsCreateNestedOneWithoutRental_itemsInputObjectZodSchema =
  makeSchema()
