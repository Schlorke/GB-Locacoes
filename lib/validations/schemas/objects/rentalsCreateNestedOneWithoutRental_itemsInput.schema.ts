...
export const rentalsCreateNestedOneWithoutRental_itemsInputObjectSchema: z.ZodType<
  Prisma.rentalsCreateNestedOneWithoutRental_itemsInput,
  Prisma.rentalsCreateNestedOneWithoutRental_itemsInput
> = z
  .object({
    create: z
  ...
  .strict()
export const rentalsCreateNestedOneWithoutRental_itemsInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => rentalsCreateWithoutRental_itemsInputObjectSchema),
