...
export const EquipmentCreateWithoutRental_itemsInputObjectSchema: z.ZodType<Prisma.EquipmentCreateWithoutRental_itemsInput, Prisma.EquipmentCreateWithoutRental_itemsInput> = z.object({
...
export const EquipmentCreateWithoutRental_itemsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().nullish(),
  pricePerDay: z.number(),
