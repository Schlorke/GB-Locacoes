  ...
  z
    .object({
      ...
      quoteItems: z
        ...
        .optional(),
      cartItems: z
        .lazy(() => CartItemCreateNestedManyWithoutEquipmentInputObjectSchema)
        .optional(),
    })
    .strict()
export const EquipmentCreateWithoutRental_itemsInputObjectSchema: z.ZodType<Prisma.EquipmentCreateWithoutRental_itemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.EquipmentCreateWithoutRental_itemsInput>
export const EquipmentCreateWithoutRental_itemsInputObjectZodSchema =
  makeSchema()
