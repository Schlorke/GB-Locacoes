...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartItemListRelationFilterObjectSchema: z.ZodType<Prisma.CartItemListRelationFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.CartItemListRelationFilter>
