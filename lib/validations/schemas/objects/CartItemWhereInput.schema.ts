...
const cartitemwhereinputSchema = z
  .object({
    AND: z
      .union([
    ...
    cart: z
      .union([
        z.lazy(() => CartScalarRelationFilterObjectSchema),
  ...
  .strict()
export const CartItemWhereInputObjectSchema: z.ZodType<Prisma.CartItemWhereInput> =
  cartitemwhereinputSchema as unknown as z.ZodType<Prisma.CartItemWhereInput>
