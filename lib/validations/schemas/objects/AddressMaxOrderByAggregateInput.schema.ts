...
const makeSchema = () =>
  z
    ...
    .strict()
export const AddressMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.AddressMaxOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.AddressMaxOrderByAggregateInput>
