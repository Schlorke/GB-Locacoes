...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartCreateOrConnectWithoutUserInputObjectSchema: z.ZodType<Prisma.CartCreateOrConnectWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartCreateOrConnectWithoutUserInput>
