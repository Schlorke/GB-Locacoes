...
const makeSchema = () =>
  z
    ...
    .strict()
export const CartCreateNestedOneWithoutItemsInputObjectSchema: z.ZodType<Prisma.CartCreateNestedOneWithoutItemsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartCreateNestedOneWithoutItemsInput>
