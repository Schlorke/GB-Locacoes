...
const makeSchema = () =>
  z
    ...
    .strict()
export const UserUpsertWithoutQuotesInputObjectSchema: z.ZodType<Prisma.UserUpsertWithoutQuotesInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpsertWithoutQuotesInput>
