...
export const QuoteItemUncheckedUpdateManyWithoutEquipmentInputObjectSchema: z.ZodType<Prisma.QuoteItemUncheckedUpdateManyWithoutEquipmentInput, Prisma.QuoteItemUncheckedUpdateManyWithoutEquipmentInput> = z.object({
...
export const QuoteItemUncheckedUpdateManyWithoutEquipmentInputObjectZodSchema = z.object({
  quoteId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  quantity: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  days: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  pricePerDay: z.union([z.number(), z.lazy(() => DecimalFieldUpdateOperationsInputObjectSchema)]).optional(),
