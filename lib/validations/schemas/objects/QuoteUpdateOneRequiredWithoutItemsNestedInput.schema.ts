...
export const QuoteUpdateOneRequiredWithoutItemsNestedInputObjectSchema: z.ZodType<
  Prisma.QuoteUpdateOneRequiredWithoutItemsNestedInput,
  Prisma.QuoteUpdateOneRequiredWithoutItemsNestedInput
> = z
  .object({
    create: z
  ...
  .strict()
export const QuoteUpdateOneRequiredWithoutItemsNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteCreateWithoutItemsInputObjectSchema),
