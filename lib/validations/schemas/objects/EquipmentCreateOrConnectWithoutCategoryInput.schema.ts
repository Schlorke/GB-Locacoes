...
export const EquipmentCreateOrConnectWithoutCategoryInputObjectSchema: z.ZodType<Prisma.EquipmentCreateOrConnectWithoutCategoryInput, Prisma.EquipmentCreateOrConnectWithoutCategoryInput> = z.object({
...
export const EquipmentCreateOrConnectWithoutCategoryInputObjectZodSchema = z.object({
  where: z.lazy(() => EquipmentWhereUniqueInputObjectSchema),
  create: z.union([z.lazy(() => EquipmentCreateWithoutCategoryInputObjectSchema), z.lazy(() => EquipmentUncheckedCreateWithoutCategoryInputObjectSchema)])
}).strict();
