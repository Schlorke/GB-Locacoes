...
export const QuoteUncheckedCreateWithoutUserInputObjectSchema: z.ZodType<
  Prisma.QuoteUncheckedCreateWithoutUserInput,
  Prisma.QuoteUncheckedCreateWithoutUserInput
> = z
  .object({
  ...
  .strict()
export const QuoteUncheckedCreateWithoutUserInputObjectZodSchema = z
  .object({
    id: z.string().optional(),
    name: z.string(),
    email: z.string(),
