...
export const QuoteItemCreateNestedManyWithoutEquipmentInputObjectSchema: z.ZodType<
  Prisma.QuoteItemCreateNestedManyWithoutEquipmentInput,
  Prisma.QuoteItemCreateNestedManyWithoutEquipmentInput
> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => QuoteItemCreateWithoutEquipmentInputObjectSchema).array(),
        z.lazy(() => QuoteItemUncheckedCreateWithoutEquipmentInputObjectSchema),
        z
          .lazy(() => QuoteItemUncheckedCreateWithoutEquipmentInputObjectSchema)
          .array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => QuoteItemCreateOrConnectWithoutEquipmentInputObjectSchema),
        z
          .lazy(() => QuoteItemCreateOrConnectWithoutEquipmentInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
  ...
  .strict()
export const QuoteItemCreateNestedManyWithoutEquipmentInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteItemCreateWithoutEquipmentInputObjectSchema),
