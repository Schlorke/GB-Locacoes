...
export const UserCreateNestedOneWithoutQuotesInputObjectSchema: z.ZodType<
  Prisma.UserCreateNestedOneWithoutQuotesInput,
  Prisma.UserCreateNestedOneWithoutQuotesInput
> = z
  .object({
    create: z
  ...
  .strict()
export const UserCreateNestedOneWithoutQuotesInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => UserCreateWithoutQuotesInputObjectSchema),
