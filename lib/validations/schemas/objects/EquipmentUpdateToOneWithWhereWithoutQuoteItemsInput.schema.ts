...
export const EquipmentUpdateToOneWithWhereWithoutQuoteItemsInputObjectSchema: z.ZodType<Prisma.EquipmentUpdateToOneWithWhereWithoutQuoteItemsInput, Prisma.EquipmentUpdateToOneWithWhereWithoutQuoteItemsInput> = z.object({
...
export const EquipmentUpdateToOneWithWhereWithoutQuoteItemsInputObjectZodSchema = z.object({
  where: z.lazy(() => EquipmentWhereInputObjectSchema).optional(),
  data: z.union([z.lazy(() => EquipmentUpdateWithoutQuoteItemsInputObjectSchema), z.lazy(() => EquipmentUncheckedUpdateWithoutQuoteItemsInputObjectSchema)])
}).strict();
