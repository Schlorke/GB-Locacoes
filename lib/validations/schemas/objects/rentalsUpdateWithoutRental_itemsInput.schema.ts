...
export const rentalsUpdateWithoutRental_itemsInputObjectSchema: z.ZodType<
  Prisma.rentalsUpdateWithoutRental_itemsInput,
  Prisma.rentalsUpdateWithoutRental_itemsInput
> = z
  .object({
    startdate: z
  ...
  .strict()
export const rentalsUpdateWithoutRental_itemsInputObjectZodSchema = z
  .object({
    startdate: z
      .union([
        z.date(),
