...
export const QuoteItemUpdateManyWithoutQuoteNestedInputObjectSchema: z.ZodType<
  Prisma.QuoteItemUpdateManyWithoutQuoteNestedInput,
  Prisma.QuoteItemUpdateManyWithoutQuoteNestedInput
> = z
  .object({
    create: z
    ...
    updateMany: z
      .union([
        z.lazy(() => QuoteItemUpdateManyWithWhereWithoutQuoteInputObjectSchema),
        z
          .lazy(() => QuoteItemUpdateManyWithWhereWithoutQuoteInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
  ...
  .strict()
export const QuoteItemUpdateManyWithoutQuoteNestedInputObjectZodSchema = z
  .object({
    create: z
      .union([
        z.lazy(() => QuoteItemCreateWithoutQuoteInputObjectSchema),
