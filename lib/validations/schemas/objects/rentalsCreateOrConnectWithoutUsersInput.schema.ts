...
export const rentalsCreateOrConnectWithoutUsersInputObjectSchema: z.ZodType<Prisma.rentalsCreateOrConnectWithoutUsersInput, Prisma.rentalsCreateOrConnectWithoutUsersInput> = z.object({
...
export const rentalsCreateOrConnectWithoutUsersInputObjectZodSchema = z.object({
  where: z.lazy(() => rentalsWhereUniqueInputObjectSchema),
  create: z.union([z.lazy(() => rentalsCreateWithoutUsersInputObjectSchema), z.lazy(() => rentalsUncheckedCreateWithoutUsersInputObjectSchema)])
}).strict();
