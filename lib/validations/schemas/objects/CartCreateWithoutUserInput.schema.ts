...
const makeSchema = () =>
  z
    .object({
      ...
      items: z
        .lazy(() => CartItemCreateNestedManyWithoutCartInputObjectSchema)
        .optional(),
    })
    .strict()
export const CartCreateWithoutUserInputObjectSchema: z.ZodType<Prisma.CartCreateWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.CartCreateWithoutUserInput>
