...
export const EquipmentCreateWithoutQuoteItemsInputObjectSchema: z.ZodType<
  Prisma.EquipmentCreateWithoutQuoteItemsInput,
  Prisma.EquipmentCreateWithoutQuoteItemsInput
> = z
  .object({
  ...
  .strict()
export const EquipmentCreateWithoutQuoteItemsInputObjectZodSchema = z
  .object({
    id: z.string().optional(),
    name: z.string(),
    description: z.string().optional().nullable(),
