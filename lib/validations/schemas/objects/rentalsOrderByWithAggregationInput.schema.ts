...
export const rentalsOrderByWithAggregationInputObjectSchema: z.ZodType<
  Prisma.rentalsOrderByWithAggregationInput,
  Prisma.rentalsOrderByWithAggregationInput
> = z
  .object({
  ...
  .strict()
export const rentalsOrderByWithAggregationInputObjectZodSchema = z
  .object({
    id: SortOrderSchema.optional(),
    startdate: SortOrderSchema.optional(),
    enddate: SortOrderSchema.optional(),
