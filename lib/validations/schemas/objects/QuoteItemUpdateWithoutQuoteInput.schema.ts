...
export const QuoteItemUpdateWithoutQuoteInputObjectSchema: z.ZodType<
  Prisma.QuoteItemUpdateWithoutQuoteInput,
  Prisma.QuoteItemUpdateWithoutQuoteInput
> = z
  .object({
    quantity: z
  ...
  .strict()
export const QuoteItemUpdateWithoutQuoteInputObjectZodSchema = z
  .object({
    quantity: z
      .union([
        z.number().int(),
