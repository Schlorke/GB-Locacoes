...
export const VerificationTokenCreateManySchema: z.ZodType<Prisma.VerificationTokenCreateManyArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as unknown as z.ZodType<Prisma.VerificationTokenCreateManyArgs>

export const VerificationTokenCreateManyZodSchema = z
  .object({
    data: z.union([
      VerificationTokenCreateManyInputObjectSchema,
      z.array(VerificationTokenCreateManyInputObjectSchema),
