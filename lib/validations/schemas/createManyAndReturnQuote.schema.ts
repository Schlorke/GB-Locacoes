...
export const QuoteCreateManyAndReturnSchema: z.ZodType<Prisma.QuoteCreateManyAndReturnArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.QuoteCreateManyAndReturnArgs>

export const QuoteCreateManyAndReturnZodSchema = z
  .object({
    select: QuoteSelectObjectSchema.optional(),
    data: z.union([
      QuoteCreateManyInputObjectSchema,
