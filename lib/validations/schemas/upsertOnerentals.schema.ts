...
export const rentalsUpsertOneSchema: z.ZodType<Prisma.rentalsUpsertArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.rentalsUpsertArgs>

export const rentalsUpsertOneZodSchema = z
  .object({
    select: rentalsSelectObjectSchema.optional(),
    include: rentalsIncludeObjectSchema.optional(),
    where: rentalsWhereUniqueInputObjectSchema,
