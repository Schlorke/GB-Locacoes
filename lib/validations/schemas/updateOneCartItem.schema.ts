...
export const CartItemUpdateOneSchema: z.ZodType<Prisma.CartItemUpdateArgs> = z
  .object({
  ...
  .strict() as unknown as z.ZodType<Prisma.CartItemUpdateArgs>

export const CartItemUpdateOneZodSchema = z
  .object({
    select: CartItemSelectObjectSchema.optional(),
    include: CartItemIncludeObjectSchema.optional(),
    data: z.union([
