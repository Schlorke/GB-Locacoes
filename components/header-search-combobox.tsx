        ...
        <div className="p-4 border-b border-slate-100">
          <div className="relative">
            <input
              ...
              className="w-full h-10 pl-12 pr-10 text-sm rounded-md border border-slate-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 outline-none transition-all placeholder:text-slate-400 text-slate-900 bg-white"
