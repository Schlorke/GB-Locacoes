              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    onClick={onClose}
                    className={cn(
                      'flex items-center gap-3 px-3 py-3 rounded-lg transition-colors text-sm font-medium border focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
