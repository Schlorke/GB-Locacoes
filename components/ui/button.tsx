...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          'border bg-background shadow-md hover:bg-accent hover:text-accent-foreground hover:scale-105 hover:shadow-lg',
        secondary:
