                ...
                <div className="space-y-1 max-h-20 overflow-y-auto whatsapp-chat-scroll">
                  {quickMessages.map((quickMsg, index) => (
                    <button
                      ...
                      className="block w-full text-left text-xs p-2 hover:bg-green-50 hover:text-green-700 rounded transition-colors border border-gray-200 hover:border-green-300 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                    >
                      • {quickMsg}
                    </button>
                  ))}
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {isOpen ? (
          ...
          <button
            ...
            className="whatsapp-green w-14 h-14 rounded-full text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
