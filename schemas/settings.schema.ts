...
export const SettingsSchema = z.object({
  ...
  // SEO
  seoTitle: z.string().min(1, 'Título SEO é obrigatório').max(60, 'Título muito longo'),
  seoDescription: z
    .string()
  ...
  // Tema e aparência
  themeColorPrimary: z.string().regex(/^#[0-9A-F]{6}$/i, 'Cor deve ser em formato hexadecimal'),
