...
<div className="sb-container">
  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      ...
      <div className="sb-grid-item">
        <img src={Share} alt="A browser window showing a Storybook being built for static deployment" />
        <h4 className="sb-section-item-heading">Build Storybook</h4>
        <p className="sb-section-item-paragraph">Build your Storybook for static deployment to share with your team.</p>
        <a
          href="https://storybook.js.org/docs/sharing/publish-storybook/?renderer=react#build-storybook-for-static-hosting"
          target="_blank"
        >Learn more<RightArrow /></a>
      </div>
      <div className="sb-grid-item">
...
<div className="sb-section sb-socials">
    ...
    <div className="sb-section-item">
      ...
      <div>
        ...
        <a
          href="https://www.youtube.com/@storybookjs"
          target="_blank"
