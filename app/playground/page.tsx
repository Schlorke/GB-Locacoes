...
const benefits = [
  {
    ...
    description:
      'Todos os nossos equipamentos possuem certificacao e passam por manutencao preventiva constante para garantir seguranca total.',
    accentColor: 'from-blue-500 to-blue-600',
  },
  {
    icon: Truck,
    title: 'Entrega Rapida e Eficiente',
    description:
      'Entregamos em toda regiao de Porto Alegre com logistica propria e rastreamento dos equipamentos em tempo real.',
  ...
  },
  {
    ...
    description:
      'Atendimento personalizado com profissionais experientes em equipamentos para obras e servicos em altura.',
  ...
  },
  {
    ...
    description:
      'Ha 10 anos oferecendo solucoes em locacao de equipamentos com foco em seguranca, qualidade e comprometimento.',
  ...
  },
  {
    ...
    description:
      'Sistema de rastreamento que identifica onde cada equipamento esta e quando foi feita a ultima manutencao.',
            ...
            <div className="bg-gradient-to-r from-orange-600 to-orange-700 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
                  ...
                  personalizada. Atendimento com seguranca, qualidade e
