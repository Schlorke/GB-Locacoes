...
export default function EquipmentDetailsPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(
          `Erro ao excluir equipamento: ${errorData.error || 'Erro desconhecido'}`
        )
      }
    } catch (error) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 p-3 sm:p-4 md:p-6 pb-24 md:pb-12 overflow-x-hidden">
      {/* Header */}
                ...
                <div className="mt-1">
                  <Badge
                    ...
                    style={{
                      ...
                      borderColor: equipment.category.bgColor
                        ? 'transparent'
                        : undefined,
                    }}
                  >
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                ...
                <p className="text-sm">
                  {new Date(equipment.createdAt).toLocaleString('pt-BR')}
                </p>
              </div>
              <div>
                <label className="text-sm font-medium text-muted-foreground">
                ...
                <p className="text-sm">
                  {new Date(equipment.updatedAt).toLocaleString('pt-BR')}
                </p>
              </div>
            </CardContent>
          </Card>
