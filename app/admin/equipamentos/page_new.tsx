  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <div className="relative overflow-hidden bg-linear-to-br from-blue-500 via-blue-600 to-blue-700 rounded-2xl p-6 text-white shadow-xl">
          {/* Clean depth layers without decorative elements */}
          <div className="absolute inset-0 bg-linear-to-br from-blue-400/12 via-transparent to-black/15"></div>
          <div className="absolute inset-0 bg-linear-to-tr from-transparent via-blue-500/6 to-blue-700/8"></div>
