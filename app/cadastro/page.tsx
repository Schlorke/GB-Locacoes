...
import { AlertTriangle, Eye, EyeOff, Mail, Lock, User, Phone, MapPin } from 'lucide-react'
      ...
      <div className="flex min-h-screen items-center justify-center px-4 pt-[120px] md:pt-0">
        <div className="w-full max-w-md relative z-10">
          <Card className="w-full shadow-2xl border-0 bg-white/95 backdrop-blur-sm rounded-2xl overflow-hidden">
            <div className="overflow-y-auto rounded-2xl max-h-[90vh]">
              <CardHeader className="text-center space-y-3 py-4 px-6">
              ...
              <CardContent className="px-6 pb-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        disabled={isLoading}
                        className="h-12 border-slate-300 focus:border-orange-500 text-sm placeholder:text-slate-400"
                        maxLength={14}
                      />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="cnpj" className="text-slate-700 font-semibold text-sm">
                        CNPJ
                      </Label>
                      <Input
                        id="cnpj"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        disabled={isLoading}
                        className="h-12 pl-10 pr-12 border-slate-300 focus:border-orange-500 text-sm placeholder:text-slate-400"
                      />
                      <Button
                        type="button"
                        variant="ghost"
                ...
                <div className="text-center">
                  <div className="text-sm text-slate-600">
                    Já tem uma conta?{' '}
                    <Link href="/login" className="text-orange-600 hover:text-orange-700 font-medium underline">
                      Faça login
                    </Link>
                  </div>
                </div>
