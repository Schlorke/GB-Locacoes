    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative -mt-10 z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Card Carrinho */}
            <Card className="relative overflow-hidden bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300">
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <CardContent className="relative z-10">
                {getItemCount() > 0 ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      <Link href="/orcamento" className="flex-1">
                        <Button className="w-full inline-flex items-center justify-center gap-2 px-6 h-12 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-xl transition-shadow duration-300 shadow-lg hover:shadow-xl">
                          Ver Carrinho
                          <ArrowRight className="h-4 w-4" />
                        </Button>
                      </Link>
                      <Link href="/equipamentos">
                        <Button className="inline-flex items-center justify-center gap-2 px-6 h-12 bg-white hover:bg-gray-50 text-gray-900 hover:text-orange-600 font-semibold rounded-xl transition-shadow duration-300 shadow-lg hover:shadow-xl">
                  ...
                  <div className="text-center py-8">
                    ...
                    <Link href="/equipamentos">
                      <Button className="inline-flex items-center justify-center gap-2 px-6 h-12 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-xl transition-shadow duration-300 shadow-lg hover:shadow-xl">
                        <Plus className="h-4 w-4" />
            ...
            <Card className="relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent className="relative z-10">
                <div className="text-center py-8">
                  ...
                  <Link href="/orcamento">
                    <Button className="inline-flex items-center justify-center gap-2 px-6 h-12 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-xl transition-shadow duration-300 shadow-lg hover:shadow-xl">
                      <Plus className="h-4 w-4" />
                      Solicitar Orçamento
                      <ArrowRight className="h-4 w-4" />
                    </Button>
          ...
          >
            <Card className="relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 group">
