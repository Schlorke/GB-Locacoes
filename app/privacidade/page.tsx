  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <article className="prose dark:prose-invert lg:prose-xl mx-auto">
        <p>
          A sua privacidade é importante para nós. É política da GB Locações respeitar a sua privacidade em relação a
          qualquer informação sua que possamos coletar no site GB Locações, e outros sites que possuímos e operamos.
        </p>
        ...
        <p>Podemos usar as informações que coletamos de várias maneiras, incluindo para:</p>
        <ul>
          ...
          <li>
            Comunicar com você, diretamente ou através de um de nossos parceiros, incluindo para atendimento ao cliente,
        ...
        <h2>3. Cookies</h2>
        <p>
          Utilizamos cookies para melhorar sua experiência. Ao acessar o site GB Locações, você concorda com o uso de
          cookies de acordo com a Política de Cookies da GB Locações.
        </p>
        <p>
          A maioria dos sites interativos de hoje em dia usa cookies que nos permitem recuperar os detalhes do usuário
          para cada visita. Eles são usados em algumas áreas do nosso site para habilitar a funcionalidade dessa área e
          facilitar o uso посетители. Alguns de nossos parceiros afiliados/publicitários também podem usar cookies.
        </p>
        ...
        <p>Ao utilizar nosso site, você concorda com a nossa política de privacidade e concorda com seus termos.</p>

        <h2>6. Alterações nesta Política de Privacidade</h2>
        <p>
          Podemos atualizar nossa Política de Privacidade de tempos em tempos. Avisaremos sobre quaisquer alterações,
          publicando a nova Política de Privacidade nesta página.
        </p>
        <p>
          Aconselhamos que você revise esta Política de Privacidade periodicamente para quaisquer alterações. As
          alterações a esta Política de Privacidade entram em vigor quando são publicadas nesta página.
        </p>
