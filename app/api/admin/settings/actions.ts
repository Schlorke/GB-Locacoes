...
export async function getSettings() {
  try {
    ...
    return {
      ...
      data: {
        ...settings,
        heroCarousel: Array.isArray(settings.heroCarousel) ? settings.heroCarousel : [],
        socialLinks: typeof settings.socialLinks === 'object' ? settings.socialLinks : {},
        businessHours: typeof settings.businessHours === 'object' ? settings.businessHours : {},
        smtpConfig: typeof settings.smtpConfig === 'object' ? settings.smtpConfig : {},
        uploadLimits: typeof settings.uploadLimits === 'object' ? settings.uploadLimits : {},
        securityConfig: typeof settings.securityConfig === 'object' ? settings.securityConfig : {},
      },
    };
  } catch (error) {
    ...
    if (existingSettings) {
      settings = await prisma.setting.update({
        ...
        data: {
          ...
          supportChat: validatedData.supportChat !== undefined ? validatedData.supportChat : true,
