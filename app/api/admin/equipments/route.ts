...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(
      "[API GET /admin/equipments] Filtros aplicados:",
    ...
    console.log(
      `[API GET /admin/equipments] Equipamentos encontrados: ${equipments.length}`,
    );
...
export async function POST(request: NextRequest) {
  try {
    console.log(
      "[API POST /admin/equipments] Iniciando criação de equipamento...",
    );
    ...
    console.log(
      "[API POST /admin/equipments] Equipamento criado com sucesso:",
      equipment.id,
    );
    return NextResponse.json(
      { ...equipment, isAvailable: equipment.available },
      { status: 201 },
    );
  } catch (error) {
    console.error(
