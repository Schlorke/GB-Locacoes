        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-orange-500 to-yellow-500 rounded-lg text-white">
              ...
              <p className="text-sm opacity-90">Entrega em toda região metropolitana de Porto Alegre</p>
            </div>
          </div>

          <div className="bg-gray-50 p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Solicite um Orçamento</h2>
            <ContactForm />
          </div>
        </div>
      </div>
