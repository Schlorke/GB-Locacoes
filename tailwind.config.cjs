...
// Import design tokens (will be generated by Style Dictionary)
let designTokens = {}
try {
  designTokens = require('./design-tokens/output/tokens-tailwind.json')
} catch (error) {
  console.warn('Design tokens not found. Run: pnpm design-system:build-tokens')
}
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        ...designTokens,
        // Fallback to existing colors if tokens not available
